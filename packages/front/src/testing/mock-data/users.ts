...
export const mockCurrentWorkspace = {
  ...
  subdomain: 'acme.bades.id',
  id: '7dfbc3f7-6e5e-4128-957e-8d86808cdf6w',
  displayName: 'Bades.id',
  inviteHash: 'bades.id-invite-hash',
    ...
    billingSubscriptionItems: [
      {
        ...
        quantity: 1,
        priceId: PRO_BASE_MONTHLY_PRICE.priceId,
        billingProduct: {
      ...
      },
      {
        ...
        hasReachedCurrentPeriodCap: false,
        quantity: null,
        priceId: PRO_METERED_MONTHLY_PRICE.priceId,
        billingProduct: {
