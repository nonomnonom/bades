...
describe('title-utils', () => {
  it('should return the correct title for a given path', () => {
    ...
    expect(getPageTitleFromPath('/welcome')).toBe('Masuk atau Buat Akun');
    expect(getPageTitleFromPath('/invite/:workspaceInviteHash')).toBe(
      'Undangan',
    );
    ...
    expect(getPageTitleFromPath('/settings/general')).toBe('Umum - Pengaturan');
