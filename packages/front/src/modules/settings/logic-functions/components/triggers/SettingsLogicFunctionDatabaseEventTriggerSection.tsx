...
export const SettingsLogicFunctionDatabaseEventTriggerSection = ({
  ...
  return (
    <SettingsLogicFunctionTriggerSection
      ...
      description={""Triggers the function when a record changes"}
      ...
      {isDefined(value) && (
        <>
          ...
          <SettingsLogicFunctionTriggerPayloadFormat
            ...
            hint={""Your handler receives this event object. "after" holds the new state, "before" the previous one (null for created), and "updatedFields" lists the field names that changed on update."}
          />
        </>
      )}
    </SettingsLogicFunctionTriggerSection>
