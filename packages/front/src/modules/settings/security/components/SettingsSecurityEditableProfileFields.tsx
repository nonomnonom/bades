...
import { MenuItemMultiSelect } from 'ui/navigation';
...
export const SettingsSecurityEditableProfileFields = () => {
  ...
  const profileFieldOptions: ProfileFieldOption[] = [
    ...
    { value: 'firstName', label: ""First Name", Icon: IconUserCircle },
    { value: 'lastName', label: ""Last Name", Icon: IconUser },
    { value: 'profilePicture', label: ""Profile Picture", Icon: IconPhoto },
  ];
  ...
  const toggleField = (field: string) => {
    if (!currentWorkspace?.id) {
      enqueueErrorSnackBar({ message: ""User is not logged in" });
      return;
    }
