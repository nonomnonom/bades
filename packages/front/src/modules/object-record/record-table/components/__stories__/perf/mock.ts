...
export const mockPerformance = {
  objectMetadataItem: {
    ...
    primaryLinkLabelSingular: 'Orang',
    primaryLinkLabelPlural: 'Orang-orang',
    description: 'Orang',
    icon: 'IconUser',
    isCustom: false,
    isRemote: false,
    ...
    fields: [
      {
        ...
        type: 'RELATION',
        name: 'keluarga',
        primaryLinkLabel: ‘Perusahaan’,
        description: ‘Perusahaan kontak’,
      ...
      },
      {
        ...
        type: 'TEXT',
        name: 'city',
        primaryLinkLabel: ‘Kota’,
        description: ‘Kota kontak’,
        icon: 'IconMap',
        isCustom: false,
        isActive: true,
        isSystem: false,
      ...
      },
      {
        ...
        primaryLinkLabel: 'Aktivitas',
        description: 'Aktivitas yang terkait dengan kontak',
        icon: 'IconCheckbox',
        isCustom: false,
        isActive: true,
        isSystem: false,
      ...
      },
      {
        ...
        primaryLinkLabel: 'Penanggung jawab kesempatan',
        description: 'Penanggung jawab kesempatan',
      ...
      },
      {
        ...
        primaryLinkLabel: 'Peserta Agenda Kalender',
        description: 'Peserta Agenda Kalender',
        icon: 'IconCalendar',
        isCustom: false,
        isActive: true,
        isSystem: true,
      ...
      },
      {
        ...
        type: 'DATE_TIME',
        name: 'createdAt',
        primaryLinkLabel: 'Tanggal Pembuatan',
      ...
      },
      {
        ...
        description: ‘Akun Linkedin kontak’,
      ...
      },
      {
        ...
        type: 'RELATION',
        name: 'attachments',
        primaryLinkLabel: 'Lampiran',
        description: 'Lampiran yang terkait dengan kontak.',
        icon: 'IconFileImport',
        isCustom: false,
        isActive: true,
        isSystem: false,
      ...
      },
      {
        ...
        type: 'POSITION',
        name: 'position',
        primaryLinkLabel: 'Posisi',
        description: 'Posisi rekam penduduk',
        icon: 'IconHierarchy2',
        isCustom: false,
        isActive: true,
        isSystem: true,
      ...
      },
      {
        ...
        type: 'EMAIL',
        name: 'email',
        primaryLinkLabel: ‘Surel’,
        description: ‘Surel kontak’,
        icon: 'IconMail',
        isCustom: false,
        isActive: true,
        isSystem: false,
      ...
      },
      {
        ...
        type: 'TEXT',
        name: 'jobTitle',
        primaryLinkLabel: ‘Jabatan’,
        description: ‘Jabatan kontak’,
        icon: 'IconBriefcase',
        isCustom: false,
        isActive: true,
        isSystem: false,
      ...
      },
      {
        ...
        type: 'DATE_TIME',
        name: 'updatedAt',
        primaryLinkLabel: 'Tanggal Pembaruan',
      ...
      },
      {
        ...
        type: 'UUID',
        name: 'companyId',
        primaryLinkLabel: 'ID perusahaan (kunci asing)',
      ...
      },
      {
        ...
        primaryLinkLabel: 'Peristiwa',
        description: 'Peristiwa yang terkait dengan perusahaan',
      ...
      },
      {
        ...
        name: 'xLink',
        primaryLinkLabel: ‘X’,
        description: ‘Akun X/Twitter kontak’,
        icon: 'IconBrandX',
        isCustom: false,
        isActive: true,
        isSystem: false,
      ...
      },
      {
        ...
        primaryLinkLabel: 'Peserta Pesan',
        description: 'Peserta Pesan',
        icon: 'IconUserCircle',
        isCustom: false,
        isActive: true,
        isSystem: true,
