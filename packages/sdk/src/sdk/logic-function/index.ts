...
// stay in `sdk/define` — they are build-time metadata factories that
// the SDK CLI stubs out before bundling. Logic-function source files keep
// importing them from `sdk/define`, but should reach for *types* (and
// future runtime helpers) here, never directly from `shared/*`.
...
export type { InputJsonSchema } from 'shared/logic-function';
