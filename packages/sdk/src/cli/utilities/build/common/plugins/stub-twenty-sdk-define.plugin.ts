...
// Everything in sdk/define is build-time metadata for the manifest
// extractor and is dead code in the user-app bundle. Stubbing it drops zod,
// shared and ~1MB per logic-function bundle.
//
...
const STUB_PRELUDE = `
// Auto-generated stub for sdk/define injected by the SDK CLI build.
// Real implementations would pull in zod, shared and ~1MB of code; at
