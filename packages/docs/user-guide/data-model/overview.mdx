...
Bades.id comes with standard objects:
...
Every business works differently. Customizing your data model means you can shape Bades.id around **your** processes instead of forcing yours into a rigid system.

Bades.id offers full flexibility:
...
Identify the main concepts you work with. Bades.id already provides:
