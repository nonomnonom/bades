---
title: Objects
description: Learn about standard and custom objects in Bades.id.
---
...
Standard objects are predefined entities in your workspace to help you get started. They're part of a shared data model accessible to all users of Bades.id. You can use them as-is, customize them or deactivate them.
