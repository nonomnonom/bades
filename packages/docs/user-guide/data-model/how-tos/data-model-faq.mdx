...
description: Frequently asked questions about Bades.id's data model.
---
...
You can rename the label of standard objects (People, Companies, Opportunities), but not their API names. The API names are fixed for consistency across all Bades.id workspaces.
</Accordion>
