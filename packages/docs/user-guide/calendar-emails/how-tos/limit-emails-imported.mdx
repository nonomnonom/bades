...
description: Control which emails are imported into Bades.id.
---

## Overview

By default, Bades.id syncs all external emails from your connected mailbox. You can limit what gets imported using **folder selection** and **visibility settings**.
