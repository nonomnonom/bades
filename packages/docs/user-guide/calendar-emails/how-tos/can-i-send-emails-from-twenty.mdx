---
title: Can I Send Emails from Bades.id?
description: Information about sending emails directly from Bades.id.
---

## Current Status

Bades.id's email integration is designed to **sync and display** your email history. Emails cannot be composed or sent directly from Bades.id's interface.
...
While you can't send emails manually from Bades.id, you **can send emails automatically using Workflows**. This is useful for:
...
For email sequences and newsletters, we recommend using workflows to connect Bades.id to a dedicated email marketing tool.
...
Native email composition from within Bades.id is on our roadmap. Join our [GitHub discussions](https://github.com/twentyhq/twenty/discussions) to share your use case and help prioritize this feature.
