---
title: Dashboards
description: Learn the basics of reporting and dashboards in Bades.id.
---
...
Dashboards in Bades.id provide a visual way to track your key performance metrics and gain insights from your CRM data.
...
<Note>
**Current limitations**:
- Exporting dashboards and sharing with external users (non-Bades.id users) are not available at the moment.
