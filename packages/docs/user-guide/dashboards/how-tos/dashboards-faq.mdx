...
description: Frequently asked questions about dashboards in Bades.id.
---

<AccordionGroup>
  <Accordion title="Can I create private dashboards?">
    No, dashboards are currently visible to everyone with access to your Bades.id workspace. Private dashboards are not yet available.
  </Accordion>
  ...
  <Accordion title="Can I share dashboards with external users?">
    No, sharing dashboards with users outside your Bades.id workspace (non-Bades.id users) is not currently supported.
  </Accordion>
