---
title: Pricing Plans
description: Learn about Bades.id's pricing plans and how to switch between them.
---

## Overview

Bades.id offers flexible pricing to fit teams of all sizes, whether you prefer cloud hosting or self-hosting.
...
### Free (Self-Hosted)
Host Bades.id on your own infrastructure at no cost:
