...
description: Step-by-step guide to migrate your Bades.id self-hosted instance to Bades.id Cloud.
---

## Overview

This guide walks you through migrating your data from a Bades.id self-hosted instance to Bades.id Cloud. The process involves setting up your cloud workspace, exporting your data, and re-importing it.
...
1. Go to [app.bades.id](https://app.bades.id) and create a new workspace
...
For complex migrations or large datasets, contact us at [contact@bades.id](mailto:contact@bades.id) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
