...
You want to tag a colleague in a note so they receive a notification to review it. Today, Bades.id doesn't support @mentions in notes or tasks.
...
<Note>
Replace `yourSubDomain` with your actual Bades.id workspace subdomain.
</Note>
