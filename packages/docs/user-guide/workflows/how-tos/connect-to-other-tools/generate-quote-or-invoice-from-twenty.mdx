---
title: Generate a Quote or Invoice from Bades.id
...
- [Generate a PDF from Bades.id](/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — attach generated PDFs to records
