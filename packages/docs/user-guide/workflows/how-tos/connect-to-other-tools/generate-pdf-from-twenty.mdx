---
title: Generate a PDF from Bades.id
description: Create a workflow to generate and attach a PDF (such as a quote) to a record.
---

Automatically generate or fetch a PDF and attach it to a record in Bades.id. This is commonly used to create quotes, invoices, or reports that are linked to Companies, Opportunities, or other objects.
...
2. Uploading the file to Bades.id
...
- [Generate a Quote or Invoice from Bades.id](/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-twenty)
