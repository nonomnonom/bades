---
title: Settings FAQ
description: Frequently asked questions about Bades.id settings.
---
...
To change your email address, please reach out to [contact@bades.id](mailto:contact@bades.id).
</Accordion>
...
- **Subdomain**: Use a Bades.id subdomain like `yourcompany.bades.id`
