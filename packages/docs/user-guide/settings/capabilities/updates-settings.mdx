...
description: Enable Early Access features in Bades.id.
---
...
<Note>
Early Access features may change based on user feedback. Your input helps us improve Bades.id!
</Note>

## Feature Feedback

Your feedback helps improve Bades.id:
