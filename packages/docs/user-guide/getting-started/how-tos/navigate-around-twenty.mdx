---
title: Navigate Around Bades.id
...
The command menu gives you **quick access to actions** in Bades.id. You can access it in two ways:
...
- Create new views
- Access deleted records (Bades.id supports soft and hard deletes)
