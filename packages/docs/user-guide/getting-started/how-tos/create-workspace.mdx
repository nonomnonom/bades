...
description: Follow a step-by-step guide on how to register on Bades.id, choose a subscription plan, and set up your account.
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

## Step 1: Registration
1. Navigate to [Bades.id Sign Up](https://app.bades.id).
...
## Support
For queries or help, connect with the dedicated support team at [contact@bades.id](mailto:contact@bades.id) or send a message on [Discord](https://discord.gg/cx5n4Jzs57).
