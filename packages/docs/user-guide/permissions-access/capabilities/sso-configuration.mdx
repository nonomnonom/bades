...
Single Sign-On (SSO) allows your team members to log into Bades.id using your organization's identity provider. This provides:
...
- Admin access to Bades.id workspace

<Note>
**For self-hosting users willing to set up SSO**, reach out to contact@bades.id
</Note>
...
- Remove them from the Bades.id workspace
...
- **Group mapping**: Map IdP groups to Bades.id roles (if available)
- **Offboarding process**: Include Bades.id in your deprovisioning workflow
