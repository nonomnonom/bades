...
description: Întrebări frecvente despre setările Bades.id.
---
...
Pentru a vă schimba adresa de e-mail, vă rugăm să ne contactați la [contact@bades.id](mailto:contact@bades.id).
</Accordion>
...
* **Subdomeniu**: Folosiți un subdomeniu Bades.id, de exemplu `yourcompany.bades.id`
