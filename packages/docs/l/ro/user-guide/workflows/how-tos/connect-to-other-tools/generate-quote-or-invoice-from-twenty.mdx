---
title: Generați o ofertă sau o factură din Bades.id
...
* [Generați un PDF din Bades.id](/l/ro/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — atașați PDF-uri generate la înregistrări
