---
title: Generați un PDF din Bades.id
description: Creați un flux de lucru pentru a genera și atașa un PDF (de exemplu, o ofertă) la o înregistrare.
---

Generați sau preluați automat un PDF și atașați-l la o înregistrare în Bades.id. Aceasta este utilizată frecvent pentru a crea oferte, facturi sau rapoarte care sunt asociate cu Companii, Oportunități sau alte obiecte.
...
2. Încărcarea fișierului în Bades.id
...
export const main = async (
  ...
  // Replace with your Bades.id GraphQL endpoints (/metadata for metadata and files or /graphql for your records)
  // Cloud: https://api.bades.id/graphql
  // Self-hosted: https://your-domain.com/graphql

  const metadataGraphqlEndpoint = 'https://api.bades.id/metadata';
  const dataGraphqlEndpoint = 'https://api.bades.id/graphql';
...
2. Transmiteți URL-ul PDF returnat către funcția logică ca parametru
...
* [Funcții logice](/l/ro/user-guide/workflows/capabilities/workflow-actions#code)
* [Generați o ofertă sau o factură din Bades.id](/l/ro/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-twenty)
