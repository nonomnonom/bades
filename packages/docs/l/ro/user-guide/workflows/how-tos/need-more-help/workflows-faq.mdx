...
description: Întrebări frecvente despre fluxurile de lucru din Bades.id.
---
...
<AccordionGroup>
  ...
  <Accordion title="Care este timpul maxim de execuție pentru acțiunile Code?">
    Acțiunile Code (funcții logice) au un **timeout implicit de 5 minute** (300 de secunde).
  ...
  <Accordion title="Care sunt limitele de rată pentru fluxurile de lucru?">
    Bades.id are două limite de rată pentru a asigura stabilitatea sistemului:
