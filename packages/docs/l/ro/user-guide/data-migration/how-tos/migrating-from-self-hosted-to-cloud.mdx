...
description: Ghid pas cu pas pentru migrarea instanței Bades.id auto-găzduite la Bades.id Cloud.
---

## Prezentare generală

Acest ghid vă ghidează prin migrarea datelor dvs. dintr-o instanță Bades.id auto-găzduită către Bades.id Cloud. Procesul presupune configurarea spațiului dvs. de lucru în cloud, exportarea datelor și reimportarea acestora.
...
1. Accesați [app.bades.id](https://app.bades.id) și creați un nou spațiu de lucru
...
Pentru migrarea complexă sau seturi mari de date, contactați-ne la [contact@bades.id](mailto:contact@bades.id) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
