...
description: Când și cum să utilizați API-urile Bades.id pentru importuri de date la scară mare.
---

## Prezentare generală

Bades.id oferă atât **GraphQL**, cât și **API-uri REST** pentru importul programatic de date. Utilizați API-ul când importul CSV nu este practic pentru volumul dvs. de date sau când aveți nevoie de importuri automate, recurente.
...
Bades.id impune limitări de rată pentru a asigura stabilitatea sistemului:
...
Bades.id acceptă două tipuri de API:
...
* Verificați că formatele corespund cerințelor Bades.id (consultați [Maparea câmpurilor](/l/ro/user-guide/data-migration/capabilities/field-mapping))
...
* Verificați că datele apar corect în Bades.id
...
Contactați-ne la [contact@bades.id](mailto:contact@bades.id) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
