...
description: Ghid complet, pas cu pas, pentru a formata datele pentru import în Bades.id.
---
...
**Acesta este cel mai important pas.** Fișierul de mostră vă arată exact denumirile de coloane și formatul pe care îl așteaptă Bades.id.
...
Bades.id impune unicitatea pentru anumite câmpuri. Valorile duplicate vor provoca erori la import.
...
3. Verificați duplicatele care există deja în Bades.id
...
* Trebuie să fie unic (fără duplicate în fișier sau în Bades.id)
...
* Trebuie să fie unic în fișierul dvs. și în Bades.id
...
* **Linkuri / Etichetă link**: `Bades.id`
* **Linkuri / URL link**: `https://bades.id`
...
* **Opțional**: Bades.id generează automat ID-uri dacă nu sunt furnizate
...
* Înregistrarea părinte trebuie să existe deja în Bades.id
...
## Pasul 6: Asigurați-vă că câmpurile există în Bades.id
