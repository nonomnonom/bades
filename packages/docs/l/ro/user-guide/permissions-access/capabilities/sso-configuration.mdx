...
Single Sign-On (SSO) le permite membrilor echipei dvs. să se autentifice în Bades.id folosind furnizorul de identitate al organizației dvs. Acest lucru oferă:
...
* Acces de administrator la spațiul de lucru Bades.id

<Note>
**Pentru utilizatorii care se auto-găzduiesc și doresc să configureze SSO**, contactați contact@bades.id
</Note>
...
* Eliminați-i din spațiul de lucru Bades.id
...
* **Maparea grupurilor**: Mapați grupurile IdP la rolurile Bades.id (dacă este disponibilă)
* **Proces de offboarding**: Includeți Bades.id în fluxul dvs. de deprovisionare
