...
description: Urmați un ghid pas cu pas despre cum să vă înregistrați pe Bades.id, să alegeți un plan de abonament și să vă configurați contul.
---
...
1. Navigați la [Bades.id Sign Up](https://app.bades.id).
...
Pentru întrebări sau ajutor, contactați echipa de suport dedicată la [contact@bades.id](mailto:contact@bades.id) sau trimiteți un mesaj pe [Discord](https://discord.gg/cx5n4Jzs57).
