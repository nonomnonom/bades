---
title: Ce este Bades.id
description: Bades.id este un CRM cu sursă deschisă care vă oferă elementele de bază pentru a crea exact ceea ce are nevoie afacerea dvs.
---
...
La început, Bades.id arată ca majoritatea CRM-urilor pe care le cunoașteți deja: puteți urmări oferte, organiza contacte, gestiona sarcini și note.
...
Open-source este fundamentul abordării noastre, asigurându-ne că Bades.id evoluează cu comunitatea sa, pentru comunitatea sa.
...
[Înregistrați-vă aici](https://app.bades.id) sau [deveniți contributor pe GitHub](https://github.com/twentyhq/twenty).
