...
description: Controlați ce e-mailuri sunt importate în Bades.id.
---

## Prezentare generală

În mod implicit, Bades.id sincronizează toate e-mailurile externe din căsuța poștală conectată. Puteți limita ce se importă folosind **selecția de dosare** și **setările de vizibilitate**.
