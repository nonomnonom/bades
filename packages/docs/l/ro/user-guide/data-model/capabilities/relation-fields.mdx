...
Relațiile de tip multe-la-multe folosesc un model de tip **obiect de legătură**: un obiect intermediar care conectează ambele părți. Cu funcția de relație cu obiect de legătură, Bades.id afișează direct înregistrările finale asociate, ascunzând obiectul intermediar din UI.
...
Bades.id include relații predefinite între obiectele standard:
