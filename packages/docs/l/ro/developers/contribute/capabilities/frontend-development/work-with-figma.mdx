...
info: Află cum poți colabora cu Figma de la Bades.id.
---
...
1. **Accesează linkul partajat:** Poți accesa fișierul Figma al proiectului [aici](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/Bades.id).
...
În bara laterală din stânga, poți accesa diferitele pagini din Figma de la Bades.id. Acestea sunt organizate astfel:
