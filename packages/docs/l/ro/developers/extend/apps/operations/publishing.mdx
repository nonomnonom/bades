...
* **Implementează un tarball** — încarcă aplicația direct pe un server Bades.id anume pentru uz intern sau privat.
...
2. Pornește o instanță de test Bades.id izolată folosind acțiunea compozită `twentyhq/twenty/.github/actions/spawn-twenty-app-dev-test@main` (echivalentul din CI al `yarn twenty docker:start --test`).
