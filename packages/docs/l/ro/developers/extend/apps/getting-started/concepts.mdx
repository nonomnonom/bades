---
title: Concepte
description: Cum funcționează aplicațiile Bades.id — modelul de entități, izolarea (sandboxing) și ciclul de viață al instalării.
icon: sitemap
---
...
| **Componentă front-end**          | Interfață React izolată (sandboxed) în Bades.id              | [Componente front-end](/l/ro/developers/extend/apps/layout/front-components)       |
