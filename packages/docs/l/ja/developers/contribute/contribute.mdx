---
title: 貢献
description: Bades.idのオープンソース開発に貢献しましょう。
---
...
Bades.idはオープンソースであり、コミュニティからの貢献を歓迎しています。 バグを修正したり、機能を追加したり、ドキュメントを改善したりするなど、あなたの貢献は、Bades.idをすべての人にとってより良いものにする助けになります。
