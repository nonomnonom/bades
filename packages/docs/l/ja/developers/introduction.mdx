---
title: 始めに
description: Bades.id 開発者ドキュメントへようこそ。Bades.id の拡張、セルフホスティング、貢献のためのリソースです。
---
