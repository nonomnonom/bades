---
title: ワークスペースを作成する
description: Bades.id に登録し、サブスクリプションプランを選択して、アカウントを設定するためのステップバイステップガイドに従ってください。
---
...
1. [Bades.idへのサインアップ](https://app.bades.id)に移動します。
...
ご質問やサポートが必要な場合は、[contact@bades.id](mailto:contact@bades.id) または [Discord](https://discord.gg/cx5n4Jzs57) で専属のサポートチームに連絡してください。
