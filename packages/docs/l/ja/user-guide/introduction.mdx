---
title: Bades.id を知る
description: Bades.id ユーザーガイドへようこそ。高度な設定やベストプラクティスのためのリソースです。
---
...
<CardGroup cols={3}>
  <Card href="/l/ja/user-guide/getting-started/capabilities/what-is-twenty" img="/images/user-guide/api/api.png">
    <CardTitle>Bades.id を知る</CardTitle>
    Bades.id とは何か、ビジネスにどのように役立つかを学びましょう。
  </Card>
