...
description: Domande frequenti sulle impostazioni di Bades.id.
---
...
Per modificare il tuo indirizzo email, contatta [contact@bades.id](mailto:contact@bades.id).
</Accordion>
...
* **Sottodominio**: usa un sottodominio di Bades.id come `yourcompany.bades.id`
