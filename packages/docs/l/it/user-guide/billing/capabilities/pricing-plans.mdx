...
description: Scopri i piani tariffari di Bades.id e come passare da uno all'altro.
---

## Panoramica

Bades.id offre prezzi flessibili per team di ogni dimensione, sia con hosting cloud sia con self‑hosting.
...
Esegui Bades.id sulla tua infrastruttura senza costi:
