---
title: Calendario
description: Informazioni sulle funzionalità di integrazione del calendario in Bades.id.
---
...
Bades.id sincronizza automaticamente gli eventi del tuo calendario e li collega ai relativi record del CRM, offrendoti una visione completa della cronologia delle riunioni con contatti e aziende.
