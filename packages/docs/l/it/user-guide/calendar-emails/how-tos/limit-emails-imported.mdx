...
description: Controlla quali email vengono importate in Bades.id.
---

## Panoramica

Per impostazione predefinita, Bades.id sincronizza tutte le email esterne dalla tua casella di posta collegata. Puoi limitare ciò che viene importato utilizzando la **selezione delle cartelle** e le **impostazioni di visibilità**.
...
2. Seleziona il tuo account email collegato
