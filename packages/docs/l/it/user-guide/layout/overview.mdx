---
title: Disposizione
description: Personalizza il modo in cui navighi, esplori e visualizzi i record in Bades.id.
---

Il layout di Bades.id è personalizzabile su tre livelli: come navighi nell'app, come consulti gli elenchi di record e cosa vedi quando apri un singolo record.
...
Le viste determinano come vengono visualizzati gli elenchi di record. Bades.id supporta tre tipi di vista:
