...
Il Single Sign-On (SSO) consente ai membri del tuo team di accedere a Bades.id utilizzando il provider di identità della tua organizzazione. Questo offre:
...
* Accesso amministratore allo spazio di lavoro Bades.id

<Note>
**Per gli utenti self-hosting che desiderano configurare l'SSO**, contatta contact@bades.id
</Note>
...
* Rimuovili dallo spazio di lavoro Bades.id
...
* **Mappatura dei gruppi**: Mappa i gruppi IdP ai ruoli di Bades.id (se disponibile)
* **Processo di offboarding**: Includi Bades.id nel tuo flusso di lavoro di deprovisioning
