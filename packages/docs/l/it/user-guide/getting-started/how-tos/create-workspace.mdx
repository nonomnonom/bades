...
description: Segui una guida passo passo su come registrarti su Bades.id, scegliere un piano di abbonamento e configurare il tuo account.
---
...
1. Vai a [Registrati su Bades.id](https://app.bades.id).
...
Per domande o aiuto, contatta il team di supporto dedicato a [contact@bades.id](mailto:contact@bades.id) o invia un messaggio su [Discord](https://discord.gg/cx5n4Jzs57).
