---
title: Widget
description: Esplora i tipi di widget e le opzioni di visualizzazione in Bades.id.
---
...
Bades.id offre diversi tipi di widget per visualizzare i dati del tuo CRM.
