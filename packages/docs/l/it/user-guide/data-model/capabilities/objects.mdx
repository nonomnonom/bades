---
title: Oggetti
description: Scopri gli oggetti standard e personalizzati in Bades.id.
---
...
Gli oggetti standard sono entità predefinite nel tuo spazio di lavoro per aiutarti a iniziare. Fanno parte di un modello di dati condiviso accessibile a tutti gli utenti di Bades.id. Puoi usarli così come sono, personalizzarli o disattivarli.
