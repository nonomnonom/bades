---
title: Genera un preventivo o una fattura da Bades.id
...
* [Generare un PDF da Bades.id](/l/it/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — allegare i PDF generati ai record
