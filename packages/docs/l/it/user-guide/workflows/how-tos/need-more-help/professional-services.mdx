...
description: Ottieni assistenza professionale per creare flussi di lavoro e automazioni complessi dal team di Bades.id e dai partner certificati.
---
...
Ottieni aiuto dal nostro team principale con i nostri pacchetti di [Onboarding da 4 ore](https://bades.id/onboarding-packages):
...
Collabora con partner certificati per personalizzazioni avanzate. Contattaci a contact@bades.id per connetterti con i nostri [partner di implementazione](https://bades.id/partners).
