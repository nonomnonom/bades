---
title: Přispět
description: Přispějte k open-source vývoji Bades.id.
---
...
Bades.id je open-source a vítá příspěvky od komunity. Ať už opravujete chyby, přidáváte funkce nebo zlepšujete dokumentaci, vaše příspěvky pomáhají zlepšovat Bades.id pro všechny.
