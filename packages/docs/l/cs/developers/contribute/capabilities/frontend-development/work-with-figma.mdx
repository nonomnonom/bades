---
title: Práce s Figma
info: Zjistěte, jak můžete spolupracovat s Figmou Bades.id
---
...
1. **Přístup ke sdílenému odkazu:** K Figma souboru projektu můžete přistoupit [zde](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/Bades.id).
...
Na levém postranním panelu můžete přistupovat k různým stránkám Figmy společnosti Bades.id. Takto jsou organizovány:
