---
title: Co je Bades.id
description: Bades.id je open-source CRM systém, který vám poskytuje stavební bloky k vytvoření přesně toho, co vaše firma potřebuje.
---
...
Zpočátku vypadá Bades.id jako většina CRM, které již znáte: můžete sledovat obchody, organizovat kontakty, řídit úkoly a poznámky.
...
Open-source je základ našeho přístupu, zajišťuje, že Bades.id se vyvíjí se svou komunitou, pro svou komunitu.
...
[Zaregistrujte se zde](https://app.bades.id) nebo [připojte se jako přispěvatel na GitHub] (https://github.com/twentyhq/twenty).
