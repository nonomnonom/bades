...
description: Sledujte podrobný návod, jak se zaregistrovat na Bades.id, vybrat si plán předplatného a nastavit svůj účet.
---
...
1. Přejděte na [Registrace Bades.id](https://app.bades.id).
...
V případě dotazů nebo potřeby pomoci kontaktujte specializovaný tým podpory na [contact@bades.id](mailto:contact@bades.id) nebo pošlete zprávu na [Discord](https://discord.gg/cx5n4Jzs57).
