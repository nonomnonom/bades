---
title: Orientace v prostředí Bades.id
...
Nabídka příkazů vám v Bades.id poskytuje **rychlý přístup k akcím**. K němu můžete přistoupit dvěma způsoby:
...
* Přistupujte k smazaným záznamům (Bades.id podporuje logické i trvalé mazání)
