...
Bades.id obsahuje standardní objekty:
...
Každý podnik funguje jinak. Přizpůsobením datového modelu můžete přetvořit Bades.id podle **svých** procesů namísto toho, abyste své procesy nutili do rigidního systému.

Bades.id nabízí plnou flexibilitu:
...
Identifikujte hlavní pojmy, se kterými pracujete. Bades.id již poskytuje:
