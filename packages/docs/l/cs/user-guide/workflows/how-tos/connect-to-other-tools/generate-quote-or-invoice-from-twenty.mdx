---
title: Vytvořte nabídku nebo fakturu z Bades.id
...
* [Vygenerovat PDF z Bades.id](/l/cs/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — připojte vygenerované soubory PDF k záznamům
