...
description: Získejte profesionální pomoc s vytvářením složitých pracovních toků a automatizací od týmu Bades.id a certifikovaných partnerů.
---
...
Získejte pomoc od našeho hlavního týmu s našimi 4hodinovými [Úvodními balíčky](https://bades.id/onboarding-packages):
...
Spolupracujte s certifikovanými partnery na pokročilých úpravách. Kontaktujte nás na contact@bades.id pro spojení s našimi [implementačními partnery](https://bades.id/partners).
