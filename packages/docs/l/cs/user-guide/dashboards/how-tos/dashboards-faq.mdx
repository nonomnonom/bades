...
description: Nejčastější dotazy k panelům v Bades.id.
---

<AccordionGroup>
  <Accordion title="Mohu vytvářet soukromé panely?">
    Ne, panely jsou nyní viditelné pro všechny, kteří mají přístup do vašeho pracovního prostoru Bades.id. Soukromé panely zatím nejsou k dispozici.
  </Accordion>
  ...
  <Accordion title="Mohu sdílet panely s externími uživateli?">
    Ne, sdílení panelů s uživateli mimo váš pracovní prostor Bades.id (uživatelé mimo Bades.id) zatím není podporováno.
  </Accordion>
