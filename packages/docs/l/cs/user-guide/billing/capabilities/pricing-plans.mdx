---
title: Cenové plány
description: Zjistěte více o cenových plánech Bades.id a jak mezi nimi přepínat.
---

## Přehled

Bades.id nabízí flexibilní ceny pro týmy všech velikostí, ať už dáváte přednost hostování v cloudu, nebo self‑hostingu.
...
Hostujte Bades.id na vlastní infrastruktuře bez poplatků:
