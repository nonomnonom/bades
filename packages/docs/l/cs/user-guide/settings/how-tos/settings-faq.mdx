---
title: Nastavení FAQ
description: Často kladené otázky k nastavení Bades.id.
---
...
Chcete-li změnit svou e-mailovou adresu, kontaktujte prosím [contact@bades.id](mailto:contact@bades.id).
</Accordion>
...
* **Poddoména**: Použijte poddoménu Bades.id, například `yourcompany.bades.id`
