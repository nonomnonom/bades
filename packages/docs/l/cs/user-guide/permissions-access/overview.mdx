...
Systém oprávnění Bades.id vám umožňuje řídit, kdo může ve vašem pracovním prostoru přistupovat k datům a kdo je může upravovat. Vytvářejte role, přiřazujte oprávnění a konfigurujte SSO pro zabezpečený přístup.
