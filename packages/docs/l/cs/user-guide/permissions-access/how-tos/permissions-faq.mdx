...
<AccordionGroup>
<Accordion title="Jaké role jsou ve Bades.id ve výchozím nastavení?">
Bades.id ve výchozím stavu obsahuje role **Administrátor** a **Člen**. Můžete vytvářet další vlastní role podle potřeb vašeho týmu (např. obchodní zástupce, manažer, uživatel pouze pro čtení).
</Accordion>
...
Můžete řídit:
* **Odeslat e-mail**: Možnost odesílat e-maily z Bades.id
...
Při zřizování JIT se uživatelské účty v Bades.id vytvoří automaticky, když se někdo poprvé přihlásí přes SSO. Automaticky jim je přiřazena výchozí role.
</Accordion>
