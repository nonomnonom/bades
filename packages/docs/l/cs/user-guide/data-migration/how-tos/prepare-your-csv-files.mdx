...
description: Kompletní návod krok za krokem, jak naformátovat data pro import do Bades.id.
---
...
**Toto je nejdůležitější krok.** Ukázkový soubor ukazuje přesné názvy sloupců a formát, který Bades.id očekává.
...
Bades.id vynucuje jedinečnost u některých polí. Duplicity způsobí chyby při importu.
...
3. Zkontrolujte duplicity, které už v Bades.id existují
...
* Musí být jedinečné (žádné duplicity v souboru ani v Bades.id)
...
* Musí být jedinečné v rámci vašeho souboru i v Bades.id
...
* **Odkazy / Štítek odkazu**: `Bades.id`
* **Odkazy / URL odkazu**: `https://bades.id`
...
* **Volitelné**: Bades.id automaticky generuje ID, pokud nejsou zadána
...
* Nadřazený záznam musí v Bades.id již existovat
...
## Krok 6: Ujistěte se, že pole v Bades.id existují
