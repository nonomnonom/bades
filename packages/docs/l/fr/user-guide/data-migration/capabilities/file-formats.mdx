...
description: Formats de fichiers pris en charge pour l’importation de données dans Bades.id.
---

## Formats pris en charge

Bades.id prend en charge trois formats de fichiers pour l’importation :
