...
description: Foire aux questions sur les paramètres de Bades.id.
---
...
<AccordionGroup>
  ...
  <Accordion title="Puis-je changer mon adresse e-mail ?">
    Pour changer votre adresse e-mail, veuillez contacter [contact@bades.id](mailto:contact@bades.id).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Puis-je personnaliser le domaine de mon espace de travail ?">
    ...
    * **Sous-domaine** : Utilisez un sous-domaine Bades.id comme `yourcompany.bades.id`
