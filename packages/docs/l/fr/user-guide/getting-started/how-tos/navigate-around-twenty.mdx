...
Le menu de commandes vous donne **un accès rapide aux actions** dans Bades.id. Vous pouvez y accéder de deux manières :
...
* Accéder aux enregistrements supprimés (Bades.id prend en charge les suppressions logiques et définitives)
