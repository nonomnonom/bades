...
description: Suivez un guide étape par étape expliquant comment s'inscrire sur Bades.id, choisir un plan d'abonnement et configurer votre compte.
---
...
1. Allez sur [Inscription à Bades.id](https://app.bades.id).
...
Pour toute question ou aide, contactez l'équipe de support dédiée à [contact@bades.id](mailto:contact@bades.id) ou envoyez un message sur [Discord](https://discord.gg/cx5n4Jzs57).
