---
title: Générer un devis ou une facture depuis Bades.id
...
* [Générer un PDF à partir de Bades.id](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — joindre les PDF générés aux enregistrements
