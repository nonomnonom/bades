...
description: Foire aux questions sur les flux de travail dans Bades.id.
---
...
<AccordionGroup>
  ...
  <Accordion title="Quel est le temps d'exécution maximal pour les actions Code ?">
    Les actions Code (fonctions logiques) ont un **délai d'expiration par défaut de 5 minutes** (300 secondes).
  ...
  <Accordion title="Quelles sont les limites de débit des flux de travail ?">
    Bades.id a deux limites de débit pour garantir la stabilité du système :
