...
Les drapeaux de fonctionnalité sont utilisés pour masquer les fonctionnalités expérimentales. Pour Bades.id, ils sont définis au niveau de l'espace de travail et non au niveau de l'utilisateur.
