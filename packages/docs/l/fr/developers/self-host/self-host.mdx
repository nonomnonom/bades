...
description: Déployez et gérez Bades.id sur votre propre infrastructure.
---
...
Bades.id peut être auto-hébergé sur votre propre infrastructure, vous offrant un contrôle total sur vos données et votre déploiement.
