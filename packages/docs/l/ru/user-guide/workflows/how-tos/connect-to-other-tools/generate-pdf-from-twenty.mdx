---
title: Создание PDF в Bades.id
description: Создайте рабочий процесс для создания и прикрепления PDF (например, коммерческого предложения) к записи.
---

Автоматически создавайте или получайте PDF и прикрепляйте его к записи в Bades.id. Это часто используют для создания коммерческих предложений, счетов или отчетов, связанных с компаниями, сделками или другими объектами.
...
* [Логические функции](/l/ru/user-guide/workflows/capabilities/workflow-actions#code)
* [Создание коммерческого предложения или счета в Bades.id](/l/ru/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-twenty)
