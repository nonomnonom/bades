---
title: Понятия
description: Как работают приложения Bades.id — модель сущностей, изоляция в песочнице и жизненный цикл установки.
icon: sitemap
---
...
| **Компонент фронтенда**   | Изолированный в песочнице интерфейс React внутри Bades.id | [Компоненты фронтенда](/l/ru/developers/extend/apps/layout/front-components)         |
