...
description: Что находится внутри сгенерированного приложения Bades.id — файлы, папки и назначение каждого из них.
icon: folder-tree
---

Новое приложение, сгенерированное с помощью `npx create-bades-app`, выглядит так:
