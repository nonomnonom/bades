...
Флаги функций используются для скрытия экспериментальных функций. Для Bades.id они устанавливаются на уровне рабочей области, а не на уровне пользователя.
