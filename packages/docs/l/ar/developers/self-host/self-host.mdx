...
description: قم بنشر Bades.id وإدارته على البنية التحتية الخاصة بك.
---
...
يمكن استضافة Bades.id ذاتيًا على البنية التحتية الخاصة بك، مما يمنحك تحكمًا كاملاً في بياناتك وعمليات النشر.
