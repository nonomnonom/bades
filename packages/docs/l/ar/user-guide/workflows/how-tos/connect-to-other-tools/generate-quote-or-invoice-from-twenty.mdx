---
title: إنشاء عرض سعر أو فاتورة من Bades.id
...
* [Generate a PDF from Bades.id](/l/ar/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — attach generated PDFs to records
