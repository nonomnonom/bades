---
title: خطط التسعير
description: تعرّف على خطط تسعير Bades.id وكيفية التبديل بينها.
---

## نظرة عامة

توفر Bades.id تسعيرًا مرنًا ليناسب الفرق بمختلف أحجامها، سواء كنت تفضّل الاستضافة السحابية أو الاستضافة الذاتية.
...
استضف Bades.id على بُنيتك التحتية الخاصة دون أي تكلفة:
