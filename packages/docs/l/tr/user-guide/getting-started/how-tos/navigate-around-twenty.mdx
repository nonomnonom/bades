...
Komut menüsü, Bades.id'de **eylemlere hızlı erişim** sağlar. İki yöntemle erişebilirsiniz:
...
* Silinen kayıtlara erişin (Bades.id yumuşak ve kalıcı silmeleri destekler)
