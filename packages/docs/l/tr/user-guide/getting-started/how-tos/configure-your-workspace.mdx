...
description: Her iş farklı çalışır. İhtiyaçlarınıza göre Bades.id'yi şekillendirmek için bu 3 adımla başlayın.
---

<Note>**Hızlı Kazanım**: Posta kutunuzu bağlayarak başlayın. Bu size anında değer katar ve ekibinizin gerçek verilerle Bades.id'yi çalışırken görmesine yardımcı olur. Ayarlar → Hesaplar altında bu işlemi gerçekleştirebilirsiniz.</Note>

## 1. Veri modelinizi özelleştirin

Bades.id, günlük ihtiyaçlarınızı en iyi şekilde destekleyecek veri modelini şekillendirmeniz için ihtiyaç duyduğunuz esnekliği sunar.
...
Mevcut verilerinizi Bades.id'ye getirmek, ekibinize baştan itibaren bağlam sunar.

### Posta kutunuzu bağlayın

Çalışma alanınızı oluştururken bunu yapmadıysanız, Ayarlar → Hesaplar altında **Google veya Microsoft hesabınızı** bağlayın. Bu, Bades.id'ye şunları yapma olanağı tanır:
