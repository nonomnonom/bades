...
description: Bades.id'ye kaydolma, bir abonelik planı seçme ve hesabınızı kurma konusunda adım adım kılavuzu takip edin.
---
...
1. [Bades.id Kayıt](https://app.bades.id) sayfasına gidin.
...
<VimeoEmbed videoId="927066829" title="Video gösterimi" />
...
Sorularınız veya yardım için, [contact@bades.id](mailto:contact@bades.id) adresindeki özel destek ekibiyle iletişime geçin veya [Discord](https://discord.gg/cx5n4Jzs57) üzerinden mesaj gönderin.
