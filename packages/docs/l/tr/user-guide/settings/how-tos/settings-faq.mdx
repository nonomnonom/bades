---
title: Ayarlar SSS
description: Bades.id ayarları hakkında sıkça sorulan sorular.
---
...
E-posta adresinizi değiştirmek için lütfen [contact@bades.id](mailto:contact@bades.id) ile iletişime geçin.
</Accordion>
...
* **Alt alan adı**: `yourcompany.bades.id` gibi bir Bades.id alt alan adı kullanın
