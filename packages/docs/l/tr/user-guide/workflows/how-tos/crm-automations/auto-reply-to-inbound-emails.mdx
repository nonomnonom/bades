...
Bades.id’de, bu parmak izi Message nesnesinde `headerMessageId` olarak saklanır. İş akışınız bunu alır ve E-posta Gönder eyleminin In-Reply-To alanına aktarır.
...
Her e-posta Bades.id'ye ulaştığında bu tetiklenir.
...
* **Yalnızca VIP'lere yanıt verin** — gönderenin alan adını veya Bades.id’de bir Contact olarak bulunup bulunmadığını kontrol eden bir dal ekleyin
