...
description: Bades.id'deki iş akışları hakkında sıkça sorulan sorular.
---
...
<AccordionGroup>
  ...
  <Accordion title="Code eylemleri için en uzun yürütme süresi nedir?">
    Code eylemlerinin (mantık fonksiyonları) **varsayılan zaman aşımı 5 dakikadır** (300 saniye).
  ...
  <Accordion title="İş akışlarına ilişkin hız sınırları nelerdir?">
    Bades.id, sistem kararlılığını sağlamak için iki hız sınırına sahiptir:
