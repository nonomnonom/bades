...
description: Bades.id'nin ekibi ve sertifikalı iş ortaklarından karmaşık iş akışları ve otomasyonlar oluşturmada profesyonel yardım alın.
---
...
Dört saatlik [Başlangıç paketlerimiz](https://bades.id/onboarding-packages) ile temel ekibimizden yardım alın:
...
Gelişmiş özelleştirmeler için sertifikalı ortaklarla çalışın. [Uygulama ortaklarımızla](https://bades.id/partners) bağlantıya geçmek için bizimle contact@bades.id adresinden iletişime geçin.
