---
title: Bades.id'den Teklif veya Fatura Oluşturun
...
* [Bades.id'den bir PDF oluşturun](/l/tr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — oluşturulan PDF'leri kayıtlara ekleyin
