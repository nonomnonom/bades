...
description: Bades.id'nin fiyatlandırması ve faturalandırması hakkında sıkça sorulan sorular.
---

## Fiyatlandırma

<AccordionGroup>
<Accordion title="Bades.id'yi kendi sunucumda ücretsiz kullanabilir miyim?">
Evet, Bades.id'yi kendi sunucunuzda ücretsiz kullanabilirsiniz. Çekirdek ekibimizin desteği hariç, Pro (Bulut) planına dahil olan her şeye erişebileceksiniz. Destek, Discord topluluğumuz üzerinden erişilebilir.

Kendiniz barındırmak istiyor ve Premium özelliklere (SSO ve satır düzeyi izinler) ihtiyaç duyuyorsanız, ücretli Kuruluş (Kendi Barındırmalı) lisansını seçebilirsiniz. Bu ayrıca Bades.id ekibinden desteği içerir ve dağıtmadan önce özel kodu açık kaynak olarak yayımlama gerekliliğini ortadan kaldırır.
</Accordion>
...
Ücretsiz koltuk sunmuyoruz. Fiyatlandırma kullanıcı başınadır ve her kullanıcının Bades.id'e erişebilmesi için bir lisansa ihtiyacı vardır.
</Accordion>
