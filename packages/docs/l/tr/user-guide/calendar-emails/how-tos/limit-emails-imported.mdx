...
description: Hangi e-postaların Bades.id'ye içe aktarılacağını kontrol edin.
---

## Genel Bakış

Varsayılan olarak, Bades.id bağlı posta kutunuzdan tüm harici e-postaları senkronize eder. **Klasör seçimi** ve **görünürlük ayarlarını** kullanarak içe aktarılanları sınırlayabilirsiniz.
...
2. Bağlı e-posta hesabınızı seçin
