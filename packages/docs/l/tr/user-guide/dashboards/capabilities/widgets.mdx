---
title: Widget'lar
description: Bades.id'deki widget türlerini ve görselleştirme seçeneklerini keşfedin.
---
...
Bades.id, Müşteri İlişkileri Yönetimi (CRM) verilerinizi görselleştirmek için çeşitli widget türleri sunar.
