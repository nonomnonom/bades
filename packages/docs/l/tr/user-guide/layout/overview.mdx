---
title: Düzen
description: Bades.id'de gezinme, göz atma ve kayıtları görüntüleme biçiminizi özelleştirin.
---

Bades.id'nin yerleşimi üç düzeyde özelleştirilebilir: uygulamada nasıl gezindiğiniz, kayıt listelerine nasıl göz attığınız ve tek bir kaydı açtığınızda ne gördüğünüz.
...
Görünümler, kayıt listelerinin nasıl görüntüleneceğini kontrol eder. Bades.id üç görünüm türünü destekler:
