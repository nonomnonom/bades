...
Çoktan çoğa ilişkiler bir **kesişim nesnesi** deseni kullanır: her iki tarafı bağlayan ara bir nesne. Kesişim ilişkisi özelliğiyle Bades.id, ara nesneyi arayüzden gizleyerek nihai bağlı kayıtları doğrudan görüntüler.
...
Bades.id, standart nesneler arasında önceden oluşturulmuş ilişkilerle birlikte gelir:
