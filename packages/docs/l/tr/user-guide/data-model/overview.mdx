...
Bades.id, standart nesnelerle birlikte gelir:
...
Her iş farklı çalışır. Veri modelinizi özelleştirmek, süreçlerinizi katı bir sisteme uydurmaya çalışmak yerine Bades.id'yi **sizin** süreçleriniz etrafında şekillendirebilmeniz demektir.

Bades.id tam esneklik sunar:
...
Üzerinde çalıştığınız temel kavramları belirleyin. Bades.id zaten şunları sunar:
