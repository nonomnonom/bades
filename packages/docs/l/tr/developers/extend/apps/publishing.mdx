...
2. `twentyhq/twenty/.github/actions/spawn-twenty-app-dev-test@main` bileşik eylemini kullanarak yalıtılmış bir Bades.id test örneği başlatır (CI'daki `yarn twenty server start --test` eşdeğeri).
