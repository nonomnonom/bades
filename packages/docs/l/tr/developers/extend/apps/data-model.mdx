---
title: Veri modeli
description: Bades.id SDK ile nesneleri, alanları, rolleri ve uygulama meta verilerini tanımlayın.
icon: database
---
...
<Note>
**Temel alanlar otomatik olarak oluşturulur.** Özel bir nesne tanımladığınızda Bades.id, standart alanları otomatik olarak ekler
...
İlişkiler nesneleri birbirine bağlar. Bades.id'de ilişkiler her zaman **çift yönlüdür** — her iki tarafı da tanımlarsınız ve her taraf diğerine başvurur.
...
Yerleşik bir Bades.id nesnesiyle (Person, Company, vb.) ilişki oluşturmak için `STANDARD_OBJECT_UNIVERSAL_IDENTIFIERS` kullanın:
