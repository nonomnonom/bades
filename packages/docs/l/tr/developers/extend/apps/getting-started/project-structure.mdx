---
title: Proje yapısı
description: Önceden hazırlanmış bir Bades.id uygulamasının içinde neler var — dosyalar, klasörler ve her birinin ne yaptığı.
icon: folder-tree
---

`npx create-bades-app` ile oluşturulan yeni bir uygulama şöyle görünür:
