...
Bir kayıt oluşturulduğunda, güncellendiğinde veya silindiğinde Bades.id URL'inize bir HTTP POST gönderir. Özel nesneler dahil tüm nesne türleri kapsanır.
