...
description: Bades.id'nin açık kaynak geliştirmesine katkıda bulunun.
---
...
Bades.id açık kaynaktır ve topluluktan gelen katkıları memnuniyetle karşılar. İster hataları düzeltiyor, ister özellikler ekliyor ya da belgeleri iyileştiriyor olun, katkılarınız Bades.id'yi herkes için daha iyi hâle getirmeye yardımcı olur.
