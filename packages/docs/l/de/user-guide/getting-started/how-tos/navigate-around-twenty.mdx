...
Das Befehlsmenü gibt Ihnen **schnellen Zugriff auf Aktionen** in Bades.id. Sie können es auf zwei Weisen aufrufen:
...
* Auf gelöschte Datensätze zugreifen (Bades.id unterstützt weiches und hartes Löschen)
