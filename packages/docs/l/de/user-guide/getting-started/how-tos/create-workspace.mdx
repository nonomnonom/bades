...
description: Folgen Sie einer Schritt-für-Schritt-Anleitung, um sich bei Bades.id anzumelden, einen Abonnementplan auszuwählen und Ihr Konto einzurichten.
---
...
1. Gehen Sie zu [Bades.id Sign Up](https://app.bades.id).
...
Bei Fragen oder Hilfe kontaktieren Sie das dedizierte Support-Team unter [contact@bades.id](mailto:contact@bades.id) oder senden Sie eine Nachricht auf [Discord](https://discord.gg/cx5n4Jzs57).
