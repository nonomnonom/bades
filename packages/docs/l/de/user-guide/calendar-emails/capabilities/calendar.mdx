---
title: Kalender
description: Die Funktionen der Kalenderintegration in Bades.id verstehen.
---
...
Bades.id synchronisiert Ihre Kalendertermine automatisch und verknüpft sie mit den entsprechenden CRM-Datensätzen, sodass Sie einen vollständigen Überblick über Ihre Meeting-Historie mit Kontakten und Unternehmen erhalten.
