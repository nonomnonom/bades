...
description: Steuern Sie, welche E-Mails in Bades.id importiert werden.
---

## Übersicht

Standardmäßig synchronisiert Bades.id alle externen E-Mails aus Ihrem verbundenen Postfach. Sie können den Import mithilfe der **Ordnerauswahl** und der **Sichtbarkeitseinstellungen** begrenzen.
