---
title: KI-FAQ
description: Häufig gestellte Fragen zu KI-Funktionen in Bades.id.
---
...
<AccordionGroup>
  ...
  <Accordion title="Welche KI-Funktionen sind geplant?">
    ...
    1. **KI-Chatbot**: Ein kontextbewusster Assistent, der auf Ihre Bades.id-Daten zugreifen kann und Sie bei Anfragen unterstützt
  ...
  <Accordion title="Kann ich meine eigenen KI-Modelle verwenden?">
    Zunächst wird Bades.id integrierte KI-Modelle verwenden. Unterstützung für benutzerdefinierte oder externe KI-Modelle kann in zukünftigen Versionen basierend auf Nutzerfeedback hinzugefügt werden.
  </Accordion>
