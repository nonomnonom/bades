...
2. **Daten in und aus Bades.id bringen**: Verbinden Sie Bades.id über API-Aufrufe und Webhooks mit Ihrer Datenbank und anderen Werkzeugen.
...
* **Formular**: Eingaben von Benutzern innerhalb der Bades.id-Oberfläche zum Zeitpunkt der Ausführung abfragen
