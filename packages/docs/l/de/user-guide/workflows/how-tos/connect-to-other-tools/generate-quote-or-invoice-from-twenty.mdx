---
title: Ein Angebot oder eine Rechnung aus Bades.id erstellen.
...
* [Ein PDF aus Bades.id generieren](/l/de/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — generierte PDFs an Datensätze anhängen
