---
title: Abrechnung
description: Verstehen Sie die Preisgestaltung von Bades.id und verwalten Sie Ihr Abonnement.
---

Bades.id bietet flexible Preispläne, die den Bedürfnissen Ihres Teams entsprechen. Verwalten Sie Ihr Abonnement, verfolgen Sie Workflow-Guthaben und greifen Sie auf Rechnungen zu – alles über **Einstellungen → Abrechnung**.

## Was enthält dieser Abschnitt

<CardGroup cols={2}>
  <Card title="Preispläne" icon="tags" href="/l/de/user-guide/billing/capabilities/pricing-plans">
    Erfahren Sie mehr über die Preispläne von Bades.id und was enthalten ist.
  </Card>
...
| **Organisation (Selbstgehostet)** | Alles aus Pro + die Premium-Funktionen (SSO, zeilenbezogene Berechtigungen), Support durch das Bades.id-Team, keine Pflicht, Ihren benutzerdefinierten Code vor der Verteilung als Open Source zu veröffentlichen |
...
**Kann ich Bades.id kostenlos nutzen?**
Ja! Hosten Sie Bades.id selbst und erhalten Sie alle Pro-Funktionen kostenlos.
