---
title: Preispläne
description: Erfahren Sie mehr über die Preispläne von Bades.id und wie Sie zwischen ihnen wechseln können.
---

## Übersicht

Bades.id bietet flexible Preise, die zu Teams jeder Größe passen – egal, ob Sie Cloud-Hosting oder Selbsthosting bevorzugen.
...
Hosten Sie Bades.id auf Ihrer eigenen Infrastruktur kostenlos:
...
* Alle Pro-Funktionen
* **Premiumfunktionen**: SSO-Integration, Berechtigungen auf Zeilenebene und KI-Nutzungsdaten
* Support durch das Bades.id-Team
