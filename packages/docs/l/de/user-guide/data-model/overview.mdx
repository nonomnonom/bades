...
Bades.id enthält Standardobjekte:
...
Jedes Unternehmen arbeitet anders. Die Anpassung Ihres Datenmodells bedeutet, dass Sie Bades.id um **Ihre** Prozesse herum gestalten können, anstatt Ihre in ein starres System zu zwängen.

Bades.id bietet volle Flexibilität:
...
Identifizieren Sie die wichtigsten Konzepte, mit denen Sie arbeiten. Bades.id bietet bereits:
