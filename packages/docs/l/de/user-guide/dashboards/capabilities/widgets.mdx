---
title: Widgets
description: Erkunden Sie die Widget-Typen und Visualisierungsoptionen in Bades.id.
---
...
Bades.id bietet verschiedene Widget-Typen, um Ihre CRM-Daten zu visualisieren.
