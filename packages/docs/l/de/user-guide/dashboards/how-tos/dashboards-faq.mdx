...
description: Häufig gestellte Fragen zu Dashboards in Bades.id.
---

<AccordionGroup>
  <Accordion title="Kann ich private Dashboards erstellen?">
    Nein, Dashboards sind derzeit für alle sichtbar, die Zugriff auf deinen Bades.id-Arbeitsbereich haben. Private Dashboards sind noch nicht verfügbar.
  </Accordion>
  ...
  <Accordion title="Kann ich Dashboards mit externen Benutzerinnen und Benutzern teilen?">
    Nein, das Teilen von Dashboards mit Benutzerinnen und Benutzern außerhalb deines Bades.id-Arbeitsbereichs (Nicht-Bades.id-Benutzer) wird derzeit nicht unterstützt.
  </Accordion>
