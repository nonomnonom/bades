...
Personalisieren Sie Ihr Bades.id-Erlebnis unter **Settings → Experience**.
...
Wählen Sie Ihre bevorzugte Sprache für die Bades.id-Oberfläche über das Dropdown-Menü.
