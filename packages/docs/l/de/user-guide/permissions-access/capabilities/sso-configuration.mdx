...
Single Sign-On (SSO) ermöglicht es Ihren Teammitgliedern, sich mit dem Identitätsanbieter Ihrer Organisation bei Bades.id anzumelden. Dies bietet:
...
* Administratorzugriff auf den Bades.id-Arbeitsbereich

<Note>
**Für Self-Hosting-Nutzer, die SSO einrichten möchten**, wenden Sie sich an contact@bades.id
</Note>
...
* Entfernen Sie sie aus dem Bades.id-Arbeitsbereich
...
* **Gruppenzuordnung**: Ordnen Sie IdP-Gruppen Bades.id-Rollen zu (falls verfügbar)
* **Offboarding-Prozess**: Beziehen Sie Bades.id in Ihren Deprovisioning-Workflow ein
