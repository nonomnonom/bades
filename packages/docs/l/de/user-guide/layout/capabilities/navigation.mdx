...
Die linke Seitenleiste ist Ihre wichtigste Möglichkeit, in Bades.id zu navigieren. Sie ist vollständig anpassbar — Sie können sie neu organisieren, damit sie zu Ihrem Workflow passt, ohne eine Einstellungsseite zu öffnen.
