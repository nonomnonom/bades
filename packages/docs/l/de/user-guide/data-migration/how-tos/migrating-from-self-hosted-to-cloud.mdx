...
description: Schritt-für-Schritt-Anleitung zur Migration Ihrer selbstgehosteten Bades.id-Instanz zu Bades.id Cloud.
---

## Übersicht

Diese Anleitung führt Sie durch die Migration Ihrer Daten von einer selbstgehosteten Bades.id-Instanz zu Bades.id Cloud. Der Prozess umfasst das Einrichten Ihres Cloud-Arbeitsbereichs, das Exportieren Ihrer Daten und deren erneutes Importieren.
...
1. Gehen Sie zu [app.bades.id](https://app.bades.id) und erstellen Sie einen neuen Arbeitsbereich
...
Bei komplexen Migrationen oder großen Datenmengen kontaktieren Sie uns unter [contact@bades.id](mailto:contact@bades.id) oder informieren Sie sich über unsere [Implementierungsservices](/l/de/user-guide/getting-started/capabilities/implementation-services).
