...
description: Wann und wie Sie die APIs von Bades.id für groß angelegte Datenimporte verwenden.
---

## Übersicht

Bades.id stellt sowohl **GraphQL**- als auch **REST-APIs** für den programmatischen Datenimport bereit. Verwenden Sie die API, wenn der CSV-Import für Ihr Datenvolumen nicht praktikabel ist oder wenn Sie automatisierte, wiederkehrende Importe benötigen.
...
Bades.id setzt Rate-Limits durch, um die Systemstabilität zu gewährleisten:
...
Bades.id unterstützt zwei API-Typen:
...
* Überprüfen Sie, ob die Formate den Anforderungen von Bades.id entsprechen (siehe [Feldzuordnung](/l/de/user-guide/data-migration/capabilities/field-mapping))
...
* Überprüfen Sie, ob die Daten in Bades.id korrekt angezeigt werden
...
Kontaktieren Sie uns unter [contact@bades.id](mailto:contact@bades.id) oder informieren Sie sich über unsere [Implementierungsservices](/l/de/user-guide/getting-started/capabilities/implementation-services).
