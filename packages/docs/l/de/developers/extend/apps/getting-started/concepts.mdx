---
title: Konzepte
description: Wie Bades.id-Apps funktionieren – Entitätenmodell, Sandboxing und Installationslebenszyklus.
icon: sitemap
---
...
| **Frontend-Komponente**    | Isolierte React-UI innerhalb von Bades.id                | [Frontend-Komponenten](/l/de/developers/extend/apps/layout/front-components)         |
