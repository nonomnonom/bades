...
description: Was in einer generierten Bades.id-App enthalten ist – Dateien, Ordner und was jede einzelne davon macht.
icon: folder-tree
---

Eine neue App, die mit `npx create-bades-app` generiert wurde, sieht so aus:
