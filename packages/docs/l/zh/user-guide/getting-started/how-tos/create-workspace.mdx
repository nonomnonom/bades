---
title: 创建工作区
description: 按照分步指南了解如何在 Bades.id 上注册，选择订阅计划，并设置您的账户。
---
...
1. 前往 [Bades.id 注册](https://app.bades.id)。
2. 选择您偏好的注册方式：
...
如有疑问或帮助，请通过[contact@bades.id](mailto:contact@bades.id)与专门的支持团队联系，或在[Discord](https://discord.gg/cx5n4Jzs57)上发送消息。
