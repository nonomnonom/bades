---
title: 什么是Bades.id
description: Bades.id 是一款开源 CRM，为您提供构建模块，助您精确打造企业所需的功能。
---
...
[在此注册](https://app.bades.id)或[成为GitHub上的贡献者](https://github.com/twentyhq/twenty)。
