...
Personalize a sua experiência no Bades.id em **Configurações → Experiência**.
...
Selecione o idioma de sua preferência para a interface do Bades.id no menu suspenso.
