...
description: Perguntas frequentes sobre as configurações do Bades.id.
---
...
Para alterar seu endereço de e-mail, entre em contato pelo [contact@bades.id](mailto:contact@bades.id).
</Accordion>
...
* **Subdomínio**: Use um subdomínio do Bades.id como `yourcompany.bades.id`
