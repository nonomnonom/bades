...
description: Saiba mais sobre os planos de preços do Bades.id e como alternar entre eles.
---

## Visão Geral

O Bades.id oferece preços flexíveis para atender equipes de todos os tamanhos, quer você prefira hospedagem em nuvem ou auto-hospedagem.
...
Hospede o Bades.id na sua própria infraestrutura sem custo:
