---
title: Widgets
description: Explore os tipos de widget e as opções de visualização no Bades.id.
---
...
O Bades.id oferece vários tipos de widget para visualizar seus dados de CRM.
