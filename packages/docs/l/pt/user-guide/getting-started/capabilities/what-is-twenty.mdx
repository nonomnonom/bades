---
title: O que é Bades.id
description: O Bades.id é um CRM de código aberto que oferece os blocos de construção para criar exatamente o que a sua empresa precisa.
---
...
À primeira vista, o Bades.id parece como a maioria dos CRMs que você já conhece: você pode acompanhar negócios, organizar contatos, gerenciar tarefas e anotações.
...
O código aberto é a base da nossa abordagem, garantindo que o Bades.id evolua com sua comunidade, para sua comunidade.
...
[Registre-se aqui](https://app.bades.id) ou [torne-se um colaborador no GitHub](https://github.com/twentyhq/twenty).
