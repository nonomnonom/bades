...
description: Siga um guia passo a passo sobre como se registrar na Bades.id, escolher um plano de assinatura e configurar sua conta.
---
...
1. Navegue até [Cadastro Bades.id](https://app.bades.id).
...
Para dúvidas ou ajuda, conecte-se com a equipe de suporte dedicada em [contact@bades.id](mailto:contact@bades.id) ou envie uma mensagem no [Discord](https://discord.gg/cx5n4Jzs57).
