...
O menu de comandos oferece **acesso rápido a ações** no Bades.id. Você pode acessá-lo de duas maneiras:
...
* Acessar registros excluídos (Bades.id dá suporte a exclusões lógicas e permanentes)
