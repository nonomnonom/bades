...
O Bades.id vem com objetos padrão:
...
Cada empresa trabalha de maneira diferente. Personalizar seu modelo de dados significa que você pode moldar o Bades.id em torno dos **seus** processos, em vez de forçar os seus a caber em um sistema rígido.

O Bades.id oferece total flexibilidade:
...
Identifique os principais conceitos com os quais você trabalha. O Bades.id já oferece:
