---
title: Gerar um PDF a partir do Bades.id
description: Crie um fluxo de trabalho para gerar e anexar um PDF (como um orçamento) a um registo.
---

Gere automaticamente ou obtenha um PDF e anexe-o a um registo no Bades.id. Isto é normalmente utilizado para criar orçamentos, faturas ou relatórios que estão associados a Empresas, Oportunidades ou outros objetos.
...
2. Carregar o ficheiro para o Bades.id
...
* [Gerar um Orçamento ou Fatura a partir do Bades.id](/l/pt/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-twenty)
