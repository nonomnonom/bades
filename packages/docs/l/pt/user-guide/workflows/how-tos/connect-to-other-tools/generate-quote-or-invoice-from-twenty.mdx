---
title: Gerar um orçamento ou fatura no Bades.id
...
* [Gerar um PDF a partir do Bades.id](/l/pt/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — anexar PDFs gerados aos registros
