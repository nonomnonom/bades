...
description: Perguntas frequentes sobre fluxos de trabalho na Bades.id.
---
...
<AccordionGroup>
  ...
  <Accordion title="Qual é o tempo máximo de execução para ações Code?">
    As ações Code (funções lógicas) têm um **tempo limite padrão de 5 minutos** (300 segundos).
  ...
  <Accordion title="Quais são os limites de taxa dos fluxos de trabalho?">
    A Bades.id tem dois limites de taxa para garantir a estabilidade do sistema:
