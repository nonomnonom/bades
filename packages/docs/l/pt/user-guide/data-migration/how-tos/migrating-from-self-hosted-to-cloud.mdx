...
description: Guia passo a passo para migrar a sua instância Bades.id auto-hospedada para a Bades.id Cloud.
---

## Visão Geral

Este guia orienta-o na migração dos seus dados de uma instância Bades.id auto-hospedada para a Bades.id Cloud. O processo envolve configurar o seu espaço de trabalho na cloud, exportar os seus dados e voltar a importá-los.
...
1. Aceda a [app.bades.id](https://app.bades.id) e crie um novo espaço de trabalho
...
Para migrações complexas ou conjuntos de dados grandes, contacte-nos em [contact@bades.id](mailto:contact@bades.id) ou explore os nossos [Serviços de Implementação](/l/pt/user-guide/getting-started/capabilities/implementation-services).
