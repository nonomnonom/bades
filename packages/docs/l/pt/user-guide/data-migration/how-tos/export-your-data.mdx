...
description: Guia completo passo a passo para exportar dados do Bades.id.
---
...
3. **Documente os mapeamentos de campos** — observe como os campos do Bades.id se mapeiam para o seu sistema de destino
