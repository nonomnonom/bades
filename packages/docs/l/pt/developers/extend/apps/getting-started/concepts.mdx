---
title: Conceitos
description: Como as aplicações Bades.id funcionam — modelo de entidade, sandboxing e ciclo de vida da instalação.
icon: sitemap
---
...
| **Componente de front-end**   | UI React em sandbox dentro do Bades.id                | [Componentes de front-end](/l/pt/developers/extend/apps/layout/front-components)        |
