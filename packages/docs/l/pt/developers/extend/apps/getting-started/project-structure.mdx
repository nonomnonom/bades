...
description: O que há dentro de um app Bades.id criado com scaffold — arquivos, pastas e o que cada um faz.
icon: folder-tree
---

Um novo app gerado por `npx create-bades-app` se parece com isto:
