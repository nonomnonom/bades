...
<CardGroup cols={3}>
  <Card href="/l/pt/developers/extend/apps/getting-started" img="/images/user-guide/halftone/dev-apps.png">
    ...
    Estenda o Bades.id com objetos personalizados, lógica do lado do servidor, componentes de UI e agentes de IA — tudo como pacotes em TypeScript.
  </Card>
  ...
  <Card href="/l/pt/developers/self-host/capabilities/docker-compose" img="/images/user-guide/halftone/dev-self-host.png">
    ...
    Execute o Bades.id na sua própria infraestrutura.
  </Card>
