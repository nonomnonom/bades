...
1. En una terminal, en el host donde Bades.id está funcionando, apague Bades.id: `docker compose down`
...
3. Vuelva a conectar Bades.id con `docker compose up -d`
...
Actualice su instancia de Bades.id para usar la imagen v0.55
...
Este problema es específico de esta versión de Bades.id y no debería ser necesario para futuras actualizaciones.
...
Actualice su instancia de Bades.id para usar la imagen v0.52
...
Actualice su instancia de Bades.id para usar la imagen v0.51
...
Actualice su instancia de Bades.id para usar la imagen v0.50.0
...
Actualice su instancia de Bades.id para usar la imagen v0.44.0
...
Actualice su instancia de Bades.id para usar la imagen v0.43.0
...
Actualice su instancia de Bades.id para usar la imagen v0.42.0
...
Actualice su instancia de Bades.id para usar la imagen v0.41.0
...
Actualice su instancia de Bades.id para usar la imagen v0.40.0
...
Actualice su instancia de Bades.id para usar la imagen v0.35.0
...
Actualice su instancia de Bades.id para usar la imagen v0.34.0
...
Actualice su instancia de Bades.id para usar la imagen v0.33.0
...
Actualice su instancia de Bades.id para usar la imagen v0.32.0
...
Actualice su instancia de Bades.id para usar la imagen v0.31.0
...
Actualice su instancia de Bades.id para usar la imagen v0.30.0

**Cambio importante**:
Para mejorar el rendimiento, Bades.id ahora requiere que la caché redis esté configurada. Hemos actualizado nuestro [docker-compose.yml](https://raw.githubusercontent.com/twentyhq/twenty/main/packages/twenty-docker/docker-compose.yml) para reflejar esto.
...
Actualice su instancia de Bades.id para usar la imagen v0.24.0
...
Actualice su instancia de Bades.id para usar la imagen v0.23.0
...
Actualice su instancia de Bades.id para usar la imagen v0.22.0
