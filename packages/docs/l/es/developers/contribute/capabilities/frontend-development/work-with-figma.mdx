...
info: Aprende cómo puedes colaborar con Bades.id en Figma
---
...
1. **Accede al enlace compartido:** Puedes acceder al archivo de Figma del proyecto [aquí](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/Bades.id).
...
En la barra lateral izquierda, puedes acceder a las diferentes páginas del Figma de Bades.id. Así es como están organizadas:
