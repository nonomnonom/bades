...
Cuando cargas un archivo, Bades.id analiza las columnas e intenta hacerlas coincidir con los campos existentes.

### Asignación automática

Bades.id intenta hacer coincidir las columnas en función de:
...
<Note>**Consejo rápido:** Exporta algunas filas del objeto que quieres importar. El archivo exportado tendrá los nombres de columna exactos que Bades.id espera, lo que hará que la asignación automática sea fluida durante la importación.</Note>

### Opciones de asignación manual

Para cada columna, puedes:

* **Asignar a un campo**: Selecciona el campo correspondiente de Bades.id desde un menú desplegable
...
Es opcional especificar un `id` durante la importación. Bades.id lo genera automáticamente si no se proporciona.
