...
description: Guía completa paso a paso para dar formato a tus datos para importarlos en Bades.id.
---
...
**Este es el paso más importante.** El archivo de ejemplo te muestra los nombres de columna y el formato exactos que Bades.id espera.
...
Bades.id exige unicidad en determinados campos. Los duplicados provocarán errores de importación.
...
3. Comprueba si hay duplicados que ya existan en Bades.id
...
* Debe ser único (sin duplicados en el archivo ni en Bades.id)
...
* Debe ser único dentro de tu archivo y en Bades.id
...
* **Enlaces / Etiqueta del enlace**: `Bades.id`
* **Enlaces / URL del enlace**: `https://bades.id`
...
* **Opcional**: Bades.id genera IDs automáticamente si no se proporcionan
...
* El registro padre debe existir previamente en Bades.id
...
## Paso 6: Asegúrate de que los campos existan en Bades.id
