---
title: Descubre Bades.id
description: Bienvenido a la Guía del usuario de Bades.id, tu recurso para configuraciones avanzadas y mejores prácticas.
---
...
<CardGroup cols={3}>
  <Card href="/l/es/user-guide/getting-started/capabilities/what-is-twenty" img="/images/user-guide/api/api.png">
    <CardTitle>Descubre Bades.id</CardTitle>
    Aprende qué es Bades.id y cómo puede ayudar a tu empresa.
  </Card>
  ...
  <Card href="/l/es/user-guide/permissions-access/overview" img="/images/user-guide/halftone/permissions.png">
    ...
    Gestiona los roles y el acceso a Bades.id.
  </Card>

  <Card href="/l/es/user-guide/billing/overview" img="/images/user-guide/halftone/billing.png">
    <CardTitle>Facturación</CardTitle>
    Comprende cómo funcionan los precios y la facturación de Bades.id.
  </Card>
