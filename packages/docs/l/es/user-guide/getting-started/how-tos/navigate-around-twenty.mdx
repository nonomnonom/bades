...
El menú de comandos te da **acceso rápido a acciones** en Bades.id. Puedes acceder de dos maneras:
...
* Crea nuevas vistas
* Accede a los registros eliminados (Bades.id admite eliminaciones lógicas y definitivas)
