...
description: Siga una guía paso a paso sobre cómo registrarse en Bades.id, elegir un plan de suscripción y configurar su cuenta.
---
...
1. Dirígete a [Bades.id Sign Up](https://app.bades.id).
...
Para consultas o ayuda, contacta con el equipo de soporte dedicado en [contact@bades.id](mailto:contact@bades.id) o envía un mensaje por [Discord](https://discord.gg/cx5n4Jzs57).
