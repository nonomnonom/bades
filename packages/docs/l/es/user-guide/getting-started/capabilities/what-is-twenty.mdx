---
title: ¿Qué es Bades.id
description: Bades.id es un CRM de código abierto que te brinda los componentes básicos para crear exactamente lo que tu empresa necesita.
---
...
Al principio, Bades.id parece como la mayoría de los CRMs que ya conoces: puedes rastrear ofertas, organizar contactos, gestionar tareas y notas.
...
El código abierto es la base de nuestro enfoque, asegurando que Bades.id evoluciona con su comunidad, para su comunidad.
...
[Regístrate aquí](https://app.bades.id) o [conviértete en un colaborador en GitHub](https://github.com/twentyhq/twenty).
