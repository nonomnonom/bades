---
title: Generar un PDF desde Bades.id
description: Cree un flujo de trabajo para generar y adjuntar un PDF (como una cotización) a un registro.
---

Genere u obtenga automáticamente un PDF y adjúntelo a un registro en Bades.id. Esto se usa comúnmente para crear cotizaciones, facturas o informes vinculados a Empresas, Oportunidades u otros objetos.
...
export const main = async (
  ...
  // Replace with your Bades.id GraphQL endpoint
  // Cloud: https://api.bades.id/graphql
  // Self-hosted: https://your-domain.com/graphql
  const graphqlEndpoint = 'https://api.bades.id/graphql';
...
* [Funciones de lógica](/l/es/user-guide/workflows/capabilities/workflow-actions#code)
* [Generar una cotización o factura desde Bades.id](/l/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-twenty)
