---
title: Generar una cotización o una factura desde Bades.id
...
* [Generar un PDF desde Bades.id](/l/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — adjuntar los PDF generados a los registros
