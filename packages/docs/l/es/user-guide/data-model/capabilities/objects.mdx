---
title: Objetos
description: Conozca los objetos estándar y personalizados en Bades.id.
---
...
Objetos estándar son entidades predefinidas en tu espacio de trabajo para ayudarte a comenzar. Forman parte de un modelo de datos compartido accesible para todos los usuarios de Bades.id. Puedes usarlos tal cual, personalizarlos o desactivarlos.
