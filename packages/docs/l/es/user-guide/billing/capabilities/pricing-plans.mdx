...
description: Obtén información sobre los planes de precios de Bades.id y cómo cambiar entre ellos.
---

## Resumen

Bades.id ofrece precios flexibles para adaptarse a equipos de todos los tamaños, tanto si prefieres alojamiento en la nube como autoalojamiento.
...
Aloja Bades.id en tu propia infraestructura sin costo:
...
* **Funciones premium**: integración de SSO y permisos a nivel de fila
* Soporte del equipo de Bades.id
