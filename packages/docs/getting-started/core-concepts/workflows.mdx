---
title: Workflows
description: Automate your business processes with Bades.id's visual workflow builder.
icon: "bolt"
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

Workflows let you automate repetitive tasks and connect Bades.id to external tools — without writing code (though you can if you want to).
...
- Sync data between Bades.id and your billing system
