...
title: Apps
icon: "cube"
description: Extend Bades.id with code — custom objects, server-side logic, UI components, and AI agents, all as TypeScript packages.
---


Most CRMs give you a config panel. Bades.id gives you a platform. Apps are how developers extend Bades.id beyond what the UI offers — defining data models, server-side logic, UI components, and AI capabilities as code, then deploying them to one or more workspaces.
...
| **Front Components** | Sandboxed React components that render inside Bades.id's UI (side panel, widgets, command menu) |
