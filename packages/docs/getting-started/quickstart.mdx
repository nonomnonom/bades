---
title: Quickstart
description: Get Bades.id up and running in under 5 minutes — on the cloud or self-hosted.
icon: "play"
---
...
<Steps>
  <Step title="Create your account">
    Go to [app.bades.id](https://app.bades.id) and sign up with Google, Microsoft, or email.
  </Step>
...
Once you're in, three steps to make Bades.id yours:

### 1. Connect your mailbox

Go to **Settings → Accounts** and connect your Google or Microsoft account. Bades.id will import your emails and calendar events, and auto-create contacts from interactions. Using another provider? You can add mailboxes via SMTP or calendars via CalDAV from the same page.
