...
for lang_dir in "$DOCS_DIR"/*/ ; do
  ...
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    -e "s|https://docs\.bades\.id/user-guide/|https://docs.bades.id/l/$lang_code/user-guide/|g" {} \; \
    -e "s|https://docs\.bades\.id/developers/|https://docs.bades.id/l/$lang_code/developers/|g" {} \; \
    -e "s|https://docs\.bades\.id/twenty-ui/|https://docs.bades.id/l/$lang_code/twenty-ui/|g" {} \;

  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    -e "s|https://docs\.bades\.id/user-guide/|https://docs.bades.id/$lang_code/user-guide/|g" {} \; \
    -e "s|https://docs\.bades\.id/developers/|https://docs.bades.id/$lang_code/developers/|g" {} \; \
    -e "s|https://docs\.bades\.id/twenty-ui/|https://docs.bades.id/$lang_code/twenty-ui/|g" {} \;
