...
info: Learn how you can collaborate with Bades.id's Figma
---
...
1. **Access the shared link:** You can access the project's Figma file [here](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/Bades.id).
...
On the left sidebar, you can access the different pages of Bades.id's Figma. This is how they're organized:
