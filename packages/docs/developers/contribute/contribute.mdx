---
title: Contribute
description: Contribute to Bades.id's open-source development.
---
<Frame>
...
Bades.id is open-source and welcomes contributions from the community. Whether you're fixing bugs, adding features, or improving documentation, your contributions help make Bades.id better for everyone.
