---
title: Self-Host
description: Deploy and manage Bades.id on your own infrastructure.
---
<Frame>
...
Bades.id can be self-hosted on your own infrastructure, giving you full control over your data and deployment.
