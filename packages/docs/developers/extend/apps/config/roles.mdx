...
- See a working example: [`hello-world/src/roles/function-role.ts`](https://github.com/badesid/bades/blob/main/packages/twenty-apps/hello-world/src/roles/function-role.ts).
