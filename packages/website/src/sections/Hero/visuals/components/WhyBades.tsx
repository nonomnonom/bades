...
const GLB_URL = '/illustrations/why-bades/hero/hero.glb';
...
function createWhyBadesScanlineMaterial(lightDirection: THREE.Vector3) {
...
function applyWhyBadesScanlineMaterials(
  ...
  modelRoot.traverse((sceneObject) => {
    ...
    const material = createWhyBadesScanlineMaterial(lightDirection);
...
export function WhyBades() {
  ...
  useEffect(() => {
    ...
    loader.load(GLB_URL, (gltf) => {
      ...
      applyWhyBadesScanlineMaterials(modelRoot, lightDirectionWorld);
