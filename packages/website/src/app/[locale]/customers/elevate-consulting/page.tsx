    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          msg`In June 2025, Justin learned Bades.id v1 had shipped. Within two or three days, the CEO asked him to look into setting up a CRM. The shift came from the potential of what could be built on top of fully open APIs. The timing was perfect.`,
        ],
        callout:
          '"It is just such a nicer experience than dealing with a Salesforce or a HubSpot. My mission has been to get every tool API-accessible, so everything talks to each other. Bades.id made that possible in a way older CRM platforms simply do not." - Justin Beadle, Director of Digital and Information, Elevate Consulting',
      },
      {
        type: 'text',
      ...
      },
      {
        ...
        paragraphs: [
          msg`Elevate's CEO was so impressed with Bades.id he started recommending it to clients before the internal setup was even complete. The team is exploring bringing Bades.id to client projects as part of their consulting practice, including as the backend for custom-built products tailored to specific operational needs.`,
