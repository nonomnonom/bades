...
const nextConfig: LinariaConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: '/user-guide',
        destination: 'https://docs.bades.id/user-guide/introduction',
        permanent: true,
      },
      {
        source: '/user-guide/section/:folder/:slug*',
        destination: 'https://docs.bades.id/user-guide/:folder/:slug*',
        permanent: true,
      },
      {
      ...
      {
        source: '/developers',
        destination: 'https://docs.bades.id/developers/introduction',
        permanent: true,
      },
      {
        source: '/developers/section/:folder/:slug*',
        destination: 'https://docs.bades.id/developers/:folder/:slug*',
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination: 'https://docs.bades.id/developers/:slug',
        permanent: true,
      },
      {
        source: '/ui',
        destination: 'https://docs.bades.id/ui/introduction',
        permanent: true,
      },
      {
        source: '/ui/section/:folder/:slug*',
        destination: 'https://docs.bades.id/ui/:folder/:slug*',
        permanent: true,
      },
      {
        source: '/ui/:folder/:slug*',
        destination: 'https://docs.bades.id/ui/:folder/:slug*',
        permanent: true,
      },
      {
