...
export const KEGIATAN_DESA_CUSTOM_FIELD_SEEDS: FieldMetadataSeed[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'Gotong Royong', value: 'GOTONG_ROYONG', position: 1, color: 'green' },
      { label: 'Hari Besar', value: 'HARI_BESAR', position: 2, color: 'red' },
      { label: 'Rapat Koordinasi', value: 'RAPAT_KOORDINASI', position: 3, color: 'purple' },
      { label: 'Penyuluhan', value: 'PENYULUHAN', position: 4, color: 'orange' },
  ...
  },
  {
    ...
    options: [
      { label: 'Direncanakan', value: 'DIRENCANAKAN', position: 0, color: 'gray' },
      { label: 'Berlangsung', value: 'BERLANGSUNG', position: 1, color: 'blue' },
