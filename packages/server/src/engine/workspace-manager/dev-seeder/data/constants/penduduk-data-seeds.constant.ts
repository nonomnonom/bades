...
export const PENDUDUK_DATA_SEEDS: PendudukDataSeed[] = [
  ...
  },
  {
    ...
    golonganDarah: 'A',
    kewarganegaraan: 'WNI',
    alamatAddressStreet1: 'Jl. Pasar Desa No. 3',
    alamatAddressCity: 'Sukamaju',
    alamatAddressCountry: 'Indonesia',
    ...
    tipeWarga: 'TETAP',
    statusHidup: 'HIDUP',
    nikAyah: '3201234567890020',
    nikIbu: '3201234567890021',
    createdBySource: 'API',
    createdByWorkspaceMemberId: KADES_USER_ID,
    createdByName: 'Drs. H. Abdullah',
    updatedBySource: 'API',
  ...
  {
    id: PENDUDUK_DATA_SEED_IDS.ID_7,
    nik: '3201234567890007',
    nomorKk: '3201234567890003',
    namaLengkapFirstName: 'Fitri',
    namaLengkapLastName: 'Handayani',
    tempatLahir: 'Ciamis',
    tanggalLahir: '1992-04-15',
    jenisKelamin: 'PEREMPUAN',
    agama: 'ISLAM',
    statusPerkawinan: 'KAWIN',
    pendidikan: 'SMA',
    ...
    tipeWarga: 'TETAP',
    statusHidup: 'HIDUP',
    nikAyah: '3201234567890022',
    nikIbu: '3201234567890023',
    createdBySource: 'API',
    createdByWorkspaceMemberId: KADES_USER_ID,
    createdByName: 'Drs. H. Abdullah',
    updatedBySource: 'API',
  ...
  {
    id: PENDUDUK_DATA_SEED_IDS.ID_8,
    nik: '3201234567890008',
    nomorKk: '3201234567890004',
    namaLengkapFirstName: 'Gunawan',
    namaLengkapLastName: 'Wibisono',
    ...
    golonganDarah: 'AB',
    kewarganegaraan: 'WNI',
    alamatAddressStreet1: 'Jl. Pendidikan No. 7',
    alamatAddressCity: 'Sukamaju',
    alamatAddressCountry: 'Indonesia',
    alamatAddressLat: -7.418,
    alamatAddressLng: 110.618,
    rt: '003',
    rw: '002',
    dusun: 'Dusun Krajan',
    statusHubunganKeluarga: 'KEPALA_KELUARGA',
    tipeWarga: 'TETAP',
    statusHidup: 'HIDUP',
    nikAyah: '3201234567890025',
    nikIbu: '3201234567890026',
    createdBySource: 'API',
    createdByWorkspaceMemberId: KADES_USER_ID,
    createdByName: 'Drs. H. Abdullah',
    updatedBySource: 'API',
  ...
  {
    id: PENDUDUK_DATA_SEED_IDS.ID_9,
    nik: '3201234567890009',
    nomorKk: '3201234567890004',
    namaLengkapFirstName: 'Hj. Neng',
    namaLengkapLastName: 'Rohayati',
    tempatLahir: 'Subang',
    ...
    tipeWarga: 'TETAP',
    statusHidup: 'HIDUP',
    nikAyah: '3201234567890027',
    nikIbu: '3201234567890028',
    createdBySource: 'API',
    createdByWorkspaceMemberId: KADES_USER_ID,
    createdByName: 'Drs. H. Abdullah',
    updatedBySource: 'API',
  ...
  {
    id: PENDUDUK_DATA_SEED_IDS.ID_10,
    nik: '3201234567890010',
    nomorKk: '3201234567890005',
    namaLengkapFirstName: 'Irfan',
    namaLengkapLastName: 'Maulana',
    tempatLahir: 'Bandung',
    ...
    rw: '003',
    dusun: 'Dusun Mekar Sari',
    statusHubunganKeluarga: 'LAINNYA',
    tipeWarga: 'TETAP',
    statusHidup: 'HIDUP',
    nikAyah: '3201234567890030',
    nikIbu: '3201234567890031',
    createdBySource: 'API',
    createdByWorkspaceMemberId: KADES_USER_ID,
    createdByName: 'Drs. H. Abdullah',
    updatedBySource: 'API',
