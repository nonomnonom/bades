...
// Bades: objek CRM warisan (company/person/opportunity) sengaja TIDAK
// dimasukkan ke navigasi default workspace. Objeknya tetap ada di engine,
// tetapi tidak lagi menyambut pengguna desa sebagai menu utama.
