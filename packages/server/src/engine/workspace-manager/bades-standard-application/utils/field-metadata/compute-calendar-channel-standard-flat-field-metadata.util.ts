...
> => ({
  ...
  contactAutoCreationPolicy: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(
        msg`Buat rekam kontak secara otomatis untuk peserta acara kalender.`,
      ),
      icon: 'IconUserCircle',
      isNullable: false,
      isUIReadOnly: true,
      ...
      options: [
        {
          ...
          label: i18nLabel(msg`Sebagai Peserta dan Penyelenggara`),
          color: 'green',
          position: 0,
        },
        {
          ...
          label: i18nLabel(msg`Sebagai Peserta`),
          color: 'orange',
          position: 1,
        },
        {
          ...
          value: 'AS_ORGANIZER',
          label: i18nLabel(msg`Sebagai Penyelenggara`),
          color: 'blue',
          position: 2,
        },
        {
