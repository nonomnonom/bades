...
>): Record<AllStandardObjectFieldName<'opportunity'>, FlatFieldMetadata> => ({
  ...
  stage: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      label: i18nLabel(msg`Tahap`),
      description: i18nLabel(msg`Tahap permohonan layanan`),
      ...
      options: [
        ...
        },
        {
          ...
          value: 'SIDAK',
          label: i18nLabel(msg`Sidak`),
          position: 2,
          color: 'sky',
        },
        {
          id: '20202020-696e-4f6b-91bc-f413e9b2f654',
          value: 'DITANDATANGANI',
          label: i18nLabel(msg`Ditandatangani`),
          position: 3,
          color: 'turquoise',
        },
        {
