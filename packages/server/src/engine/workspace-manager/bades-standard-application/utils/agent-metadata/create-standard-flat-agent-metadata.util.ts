import { AUTO_SELECT_SMART_MODEL_ID } from 'shared/constants';
import { type FlatAgent } from 'src/engine/metadata-modules/flat-agent/types/flat-agent.type';
import { type AllStandardAgentName } from 'src/engine/workspace-manager/bades-standard-application/types/all-standard-agent-name.type';
import {
  type CreateStandardAgentArgs,
  createStandardAgentFlatMetadata,
} from 'src/engine/workspace-manager/bades-standard-application/utils/agent-metadata/create-standard-agent-flat-metadata.util';
  ...
  helper: (args: Omit<CreateStandardAgentArgs, 'context'>) =>
    createStandardAgentFlatMetadata({
      ...
      context: {
        ...
        label: 'Helper',
        description:
          'AI agent specialized in helping users learn how to use Bades',
        icon: 'IconHelp',
        prompt: `You are a Helper Agent for Bades. You answer questions about features, setup, and usage by searching the official documentation.
...
Always base answers on official Bades documentation. Be patient and helpful.`,
