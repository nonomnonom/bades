  ...
  note: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        nameSingular: 'note',
        namePlural: 'notes',
        labelSingular: i18nLabel(msg`Catatan Desa`),
        labelPlural: i18nLabel(msg`Catatan Desa`),
        description: i18nLabel(msg`Catatan administrasi dan kegiatan desa`),
        icon: 'IconNotes',
        isSearchable: true,
        shortcut: 'N',
        labelIdentifierFieldMetadataName: 'title',
  ...
  noteTarget: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        labelSingular: i18nLabel(msg`Target Catatan Desa`),
        labelPlural: i18nLabel(msg`Target Catatan Desa`),
        description: i18nLabel(msg`Target catatan desa`),
        icon: 'IconCheckbox',
        isSystem: true,
        labelIdentifierFieldMetadataName: 'id',
      },
  ...
  task: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        nameSingular: 'task',
        namePlural: 'tasks',
        labelSingular: i18nLabel(msg`Tugas Desa`),
        labelPlural: i18nLabel(msg`Tugas Desa`),
        description: i18nLabel(msg`Penugasan untuk perangkat desa`),
        icon: 'IconCheckbox',
        isSearchable: true,
        shortcut: 'T',
        labelIdentifierFieldMetadataName: 'title',
  ...
  taskTarget: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        labelSingular: i18nLabel(msg`Target Tugas Desa`),
        labelPlural: i18nLabel(msg`Target Tugas Desa`),
        description: i18nLabel(msg`Target tugas desa`),
        icon: 'IconCheckbox',
        isSystem: true,
        labelIdentifierFieldMetadataName: 'id',
      },
