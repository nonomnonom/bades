    ...
    rows: withActorAudit([
      {
        ...
        kewarganegaraan: 'WNI',
        statusHidup: 'HIDUP',
        // Koordinat dummy diselaraskan dengan keluarga KK Budi Santoso
        // agar marker peta "Peta Penduduk" overlap dengan "Peta Keluarga".
        alamatAddressLat: -7.4100,
        alamatAddressLng: 110.6100,
        rt: '001',
        rw: '001',
        dusun: 'Krajan',
      ...
      },
      {
        ...
        kewarganegaraan: 'WNI',
        statusHidup: 'HIDUP',
        alamatAddressLat: -7.4110,
        alamatAddressLng: 110.6110,
        rt: '001',
        rw: '001',
        dusun: 'Krajan',
        statusHubunganKeluarga: 'KEPALA_KELUARGA',
      ...
      },
      {
        ...
        kewarganegaraan: 'WNI',
        statusHidup: 'HIDUP',
        alamatAddressLat: -7.4090,
        alamatAddressLng: 110.6090,
        rt: '001',
        rw: '001',
        dusun: 'Krajan',
        statusHubunganKeluarga: 'KEPALA_KELUARGA',
      ...
      },
      {
        ...
        kewarganegaraan: 'WNI',
        statusHidup: 'HIDUP',
        alamatAddressLat: -7.4200,
        alamatAddressLng: 110.6200,
        rt: '001',
        rw: '002',
        dusun: 'Mekar Sari',
        statusHubunganKeluarga: 'KEPALA_KELUARGA',
  ...
  // -----------------------------------------------------------------------
  {
    ...
    rows: withActorAudit([
      ...
      },
      {
        ...
        lokasiAddressLat: -7.4200,
        lokasiAddressLng: 110.6200,
        tahunPerolehan: '2015',
        asalPerolehan: 'HIBAH',
      ...
      },
      {
        ...
        lokasiAddressLat: -7.4110,
        lokasiAddressLng: 110.6110,
        tahunPerolehan: '2018',
        asalPerolehan: 'BANTUAN_PEMERINTAH',
