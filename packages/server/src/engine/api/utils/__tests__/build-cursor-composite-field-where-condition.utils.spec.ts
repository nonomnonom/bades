...
import { FieldMetadataType, OrderByDirection } from 'shared/types';
  ...
  describe('eq operator cases', () => {
    it('should handle eq operator', () => {
      const result = buildCursorCompositeFieldWhereCondition({
        ...
        cursorValue: { firstName: 'Budi', lastName: 'Saputra' },
    ...
    const singlePropertyTestCases: EachTestingContext<{
    ...
    }>[] = [
      {
        ...
        context: {
          ...
          fieldType: FieldMetadataType.FULL_NAME,
          fieldKey: 'penduduk',
          orderBy: [{ penduduk: { firstName: OrderByDirection.AscNullsLast } }],
    ...
    const multiplePropertiesTestCases: EachTestingContext<{
    ...
    }>[] = [
      {
        ...
        context: {
          ...
          value: { firstName: 'Budi', lastName: 'Saputra' },
          isForwardPagination: true,
        },
      },
      {
