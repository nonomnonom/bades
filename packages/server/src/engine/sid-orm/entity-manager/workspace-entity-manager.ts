...
} from 'src/engine/sid-orm/repository/permissions.utils';
import { WorkspaceSelectQueryBuilder } from 'src/engine/sid-orm/repository/workspace-select-query-builder';
import { WorkspaceRepository } from 'src/engine/sid-orm/repository/workspace.repository';
import { getWorkspaceContext } from 'src/engine/sid-orm/storage/orm-workspace-context.storage';
...
export class WorkspaceEntityManager extends EntityManager {
  ...
  override getRepository<Entity extends ObjectLiteral>(
    ...
    if (rolePermissionConfig && 'unionOf' in rolePermissionConfig) {
      ...
      objectPermissions = computePermissionUnion(allRolePermissions);
    }
  ...
  >(
    ...
    try {
      ...
      throw await computeSidOrmException(
        error,
        objectMetadataItem,
        this,
        this.internalContext,
