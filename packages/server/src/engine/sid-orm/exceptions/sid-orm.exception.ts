...
export enum SidOrmExceptionCode {
...
const getSidOrmExceptionUserFriendlyMessage = (
  ...
  switch (code) {
    ...
    case SidOrmExceptionCode.WORKSPACE_SCHEMA_NOT_FOUND:
      return msg`Workspace schema not found.`;
    case SidOrmExceptionCode.ROLES_PERMISSIONS_VERSION_NOT_FOUND:
      return msg`Roles and permissions configuration not found.`;
    case SidOrmExceptionCode.FEATURE_FLAG_MAP_VERSION_NOT_FOUND:
      return msg`Feature configuration not found.`;
    case SidOrmExceptionCode.USER_WORKSPACE_ROLE_MAP_VERSION_NOT_FOUND:
      return msg`User workspace role configuration not found.`;
    case SidOrmExceptionCode.API_KEY_ROLE_MAP_VERSION_NOT_FOUND:
      return msg`API key role configuration not found.`;
    case SidOrmExceptionCode.MALFORMED_METADATA:
      return msg`Data structure is invalid.`;
    case SidOrmExceptionCode.WORKSPACE_NOT_FOUND:
      return msg`Workspace not found.`;
    case SidOrmExceptionCode.CONNECT_RECORD_NOT_FOUND:
      return msg`Related record not found.`;
    case SidOrmExceptionCode.CONNECT_NOT_ALLOWED:
      return msg`This connection is not allowed.`;
    case SidOrmExceptionCode.CONNECT_UNIQUE_CONSTRAINT_ERROR:
      return msg`A record with this relationship already exists.`;
    case SidOrmExceptionCode.MISSING_MAIN_ALIAS_TARGET:
      return msg`Missing main alias target.`;
    case SidOrmExceptionCode.METHOD_NOT_ALLOWED:
    ...
    case SidOrmExceptionCode.TOO_MANY_RECORDS_TO_UPDATE:
      return msg`Too many records to update at once.`;
    case SidOrmExceptionCode.INVALID_INPUT:
      return msg`Invalid input provided.`;
    case SidOrmExceptionCode.RLS_VALIDATION_FAILED:
      return msg`Record does not satisfy security constraints.`;
    case SidOrmExceptionCode.ENUM_TYPE_NAME_NOT_FOUND:
    case SidOrmExceptionCode.ORM_EVENT_DATA_CORRUPTED:
      return STANDARD_ERROR_MESSAGE;
    case SidOrmExceptionCode.NO_ROLE_FOUND_FOR_USER_WORKSPACE:
...
export class SidOrmException extends CustomException<SidOrmExceptionCode> {
  constructor(
    message: string,
    code: SidOrmExceptionCode,
    ...
    super(message, code, {
      userFriendlyMessage:
        userFriendlyMessage ?? getSidOrmExceptionUserFriendlyMessage(code),
    });
  }
}
