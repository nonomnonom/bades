...
export const PENDUDUK_FLAT_FIELDS_MOCK = {
  ...
  linkedinLink: getFlatFieldMetadataMock({
    ...
    description: 'Akun LinkedIn penduduk',
  ...
  xLink: getFlatFieldMetadataMock({
    ...
    description: 'Akun X (Twitter) penduduk',
    icon: 'IconBrandX',
    standardOverrides: null,
    options: null,
    settings: null,
  ...
  jobTitle: getFlatFieldMetadataMock({
    ...
    label: 'Pekerjaan',
    defaultValue: "''",
    description: 'Pekerjaan penduduk',
    icon: 'IconBriefcase',
    standardOverrides: null,
    options: null,
    settings: null,
  ...
  phones: getFlatFieldMetadataMock({
    ...
    description: 'Nomor telepon penduduk',
    icon: 'IconPhone',
    standardOverrides: null,
    options: null,
    settings: null,
  ...
  city: getFlatFieldMetadataMock({
    ...
    label: 'Kota',
    defaultValue: "''",
    description: 'Kota tempat tinggal penduduk',
    icon: 'IconMap',
    standardOverrides: null,
    options: null,
    settings: null,
  ...
  avatarUrl: getFlatFieldMetadataMock({
    ...
    label: 'Foto Profil',
    defaultValue: "''",
    description: 'URL foto profil penduduk',
    icon: 'IconFileUpload',
    standardOverrides: null,
    options: null,
    settings: null,
  ...
  position: getFlatFieldMetadataMock({
    ...
    label: 'Posisi',
    defaultValue: 0,
    description: 'Posisi record penduduk',
    icon: 'IconHierarchy2',
    standardOverrides: null,
    options: null,
    settings: null,
  ...
  company: getFlatFieldMetadataMock({
    ...
    label: 'Keluarga',
    defaultValue: null,
    description: 'Keluarga yang menaungi penduduk',
    icon: 'IconHome',
    standardOverrides: null,
    options: null,
    settings: {
  ...
  pointOfContactForOpportunities: getFlatFieldMetadataMock({
    ...
    defaultValue: null,
    description:
      'Daftar program bantuan yang dikoordinasikan oleh penduduk ini',
  ...
  taskTargets: getFlatFieldMetadataMock({
    ...
    label: 'Daftar Tugas',
    defaultValue: null,
    description: 'Tugas yang terkait dengan penduduk',
    icon: 'IconCheckbox',
    standardOverrides: null,
    options: null,
    settings: { relationType: RelationType.ONE_TO_MANY },
  ...
  noteTargets: getFlatFieldMetadataMock({
    ...
    defaultValue: null,
    description: 'Catatan yang terkait dengan penduduk',
    icon: 'IconNotes',
    standardOverrides: null,
    options: null,
    settings: { relationType: RelationType.ONE_TO_MANY },
  ...
  attachments: getFlatFieldMetadataMock({
    ...
    label: 'Lampiran',
    defaultValue: null,
    description: 'Lampiran yang terkait dengan penduduk',
    icon: 'IconFileImport',
    standardOverrides: null,
    options: null,
    settings: { relationType: RelationType.ONE_TO_MANY },
  ...
  timelineActivities: getFlatFieldMetadataMock({
    ...
    label: 'Linimasa',
    defaultValue: null,
    description: 'Linimasa aktivitas penduduk',
