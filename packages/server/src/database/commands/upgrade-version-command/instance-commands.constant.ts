...
import { AddMidtransBillingFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-7/2-7-instance-command-fast-1779389311837-add-midtrans-billing';
...
export const INSTANCE_COMMANDS = [
  ...
  AddMidtransBillingFastInstanceCommand,
];
