...
1. Register / install this app on your Bades.id server (`bades-slack`).
2. In **Settings → Applications → Bades Slack**, open the **Application registration**
...
```bash
cd packages/apps/internal/slack
yarn install
yarn lint
yarn test
```
