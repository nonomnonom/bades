...
- Contact the team at `security at bades.id`.
...
While Bades.id doesn't have a formal bug bounty program right now due to the project's nascent stage, rest assured that:
...
- Your contribution is greatly appreciated, and Bades.id would acknowledge your role in the vulnerability fix, if you opt for identification.
- Bades.id will grant you permission to publicly discuss your findings once users have had a reasonable time to apply the patch after it becomes available.
- Bades.id guarantees not to pursue any legal action as long as the vulnerability is not exploited.
...
Note: This does not apply to security vulnerabilities. If you're in doubt, then always follow the security vulnerability process above.